...
[Nix](https://github.com/nixos/nix) ⭐ 17,734 | 🐛 2,958 | 🌐 C++ | 📅 2026-09-17 is a powerful package manager for Linux and other Unix systems that makes package management reliable and reproducible.
...
* [NixOS & Flakes Book](https://github.com/ryan4yin/nixos-and-flakes-book) ⭐ 3,292 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-05 - An unofficial and opinionated NixOS & Flakes book for beginners.
...
* [nix-installer](https://github.com/DeterminateSystems/nix-installer) ⭐ 3,688 | 🐛 439 | 🌐 Rust | 📅 2026-09-16 - Opinionated alternative to the official Nix install scripts.
* [nixos-anywhere](https://github.com/nix-community/nixos-anywhere) ⭐ 3,446 | 🐛 104 | 🌐 Shell | 📅 2026-09-16 - Install NixOS everywhere via SSH.
...
* [Colmena](https://github.com/nix-community/colmena) ⭐ 2,344 | 🐛 147 | 🌐 Rust | 📅 2026-09-10 - A simple, stateless NixOS deployment tool modeled after NixOps and morph.
* [deploy-rs](https://github.com/serokell/deploy-rs) ⭐ 2,325 | 🐛 131 | 🌐 Rust | 📅 2026-09-14 - A simple multi-profile Nix-flake deploy tool.
...
* [comin](https://github.com/nlewo/comin) ⭐ 1,018 | 🐛 47 | 🌐 Go | 📅 2026-09-16 - A deployment tool to continuously pull from Git repositories.
* [KuberNix](https://github.com/saschagrunert/kubernix) ⭐ 824 | 🐛 0 | 🌐 Rust | 📅 2026-09-17 - Single-dependency Kubernetes clusters via Nix packages.
* [KubeNix](https://github.com/hall/kubenix) ⭐ 521 | 🐛 28 | 🌐 Nix | 📅 2026-09-13 - A Kubernetes resource builder using Nix.
...
* [microvm](https://github.com/microvm-nix/microvm.nix) ⭐ 2,943 | 🐛 58 | 🌐 Nix | 📅 2026-09-15 - NixOS-based MicroVMs.
* [nixos-shell](https://github.com/Mic92/nixos-shell) ⭐ 914 | 🐛 13 | 🌐 Nix | 📅 2026-09-17 - Simple headless VM configuration using Nix (similar to Vagrant).
...
* [agent-sandbox.nix](https://github.com/archie-judd/agent-sandbox.nix) ⭐ 157 | 🐛 3 | 🌐 Shell | 📅 2026-09-13 - Declarative sandboxing for any package (e.g. AI coding agents) using bubblewrap on Linux and sandbox-exec on macOS.

## Command-Line Tools

* [devenv](https://github.com/cachix/devenv) ⭐ 7,658 | 🐛 370 | 🌐 Rust | 📅 2026-09-16 - A Nix-based tool for creating developer shell environments quickly and reproducibly.
* [nh](https://github.com/nix-community/nh) ⭐ 3,209 | 🐛 83 | 🌐 Rust | 📅 2026-09-16 - Better output for `nix`, `nixos-rebuild`, `home-manager` and nix-darwin CLI leveraging `dix` and `nix-output-monitor`.
* [comma](https://github.com/nix-community/comma) ⭐ 1,766 | 🐛 11 | 🌐 Rust | 📅 2026-09-01 - Quickly run any binary; wraps together `nix run` and `nix-index`.
...
* [nix-init](https://github.com/nix-community/nix-init) ⭐ 1,468 | 🐛 30 | 🌐 Rust | 📅 2026-09-16 - Generate Nix packages from URLs with hash prefetching, dependency inference, license detection, and more.
...
* [nurl](https://github.com/nix-community/nurl) ⭐ 787 | 🐛 17 | 🌐 Rust | 📅 2026-09-14 - Generate Nix fetcher calls from repository URLs.
...
* [angrr](https://github.com/linyinfeng/angrr) ⭐ 146 | 🐛 6 | 🌐 Rust | 📅 2026-09-17 - Auto Nix GC Roots Retention. This tool simply deletes auto GC roots based on the modified time of their symbolic link target.
...
* [Devbox](https://github.com/jetify-com/devbox) ⭐ 12,362 | 🐛 414 | 🌐 Go | 📅 2026-09-17 - Instant, portable, and predictable development environments.
* [flox](https://github.com/flox/flox) ⭐ 4,126 | 🐛 435 | 🌐 Rust | 📅 2026-09-17 - Manage and share development environments, package projects, and publish artifacts anywhere.
* [nix-direnv](https://github.com/nix-community/nix-direnv) ⭐ 2,779 | 🐛 8 | 🌐 Shell | 📅 2026-09-13 - A fast loader and flake-compliant configuration for the direnv environment auto-loader.
* [attic](https://github.com/zhaofengli/attic) ⭐ 2,073 | 🐛 174 | 🌐 Rust | 📅 2026-09-16 - Multi-tenant Nix Binary Cache.
* [nil](https://github.com/oxalica/nil) ⭐ 1,911 | 🐛 34 | 🌐 Rust | 📅 2026-07-26 - NIx Language server, an incremental analysis assistent for writing in Nix.
...
* [nixd](https://github.com/nix-community/nixd) ⭐ 1,487 | 🐛 105 | 🌐 C++ | 📅 2026-09-14 - Nix language server, based on Nix libraries.
* [flake.parts](https://github.com/hercules-ci/flake-parts) ⭐ 1,469 | 🐛 76 | 🌐 Nix | 📅 2026-09-03 - Minimal Nix modules framework for Flakes: split your flakes into modules and get things done with community modules.
...
* [MCP-NixOS](https://github.com/utensils/mcp-nixos) ⭐ 836 | 🐛 0 | 🌐 Python | 📅 2026-09-05 - An MCP server that provides AI assistants with accurate information about NixOS packages, options, Home Manager, and nix-darwin configurations.
...
* [haskell.nix](https://github.com/input-output-hk/haskell.nix) ⭐ 631 | 🐛 105 | 🌐 Nix | 📅 2026-09-17 - Alternative Haskell Infrastructure for Nixpkgs.
...
* [poetry2nix](https://github.com/nix-community/poetry2nix) ⭐ 929 | 🐛 188 | 🌐 Nix | 📅 2026-09-17 - Build Python packages directly from [Poetry's](https://python-poetry.org/) `poetry.lock`. No conversion step needed.
* [uv2nix](https://github.com/pyproject-nix/uv2nix) ⭐ 783 | 🐛 2 | 🌐 Nix | 📅 2026-09-15 - Convert [`uv` workspaces](https://docs.astral.sh/uv/concepts/projects/workspaces/) into pure Nix derivations.
...
* [fenix](https://github.com/nix-community/fenix) ⭐ 1,117 | 🐛 40 | 🌐 Nix | 📅 2026-09-17 - Rust toolchains and Rust analyzer nightly for nix.
...
* [nix-cargo-integration](https://github.com/90-008/nix-cargo-integration) ⭐ 217 | 🐛 5 | 🌐 Nix | 📅 2026-09-17 - A library that allows easy and effortless integration for Cargo projects.
...
* [zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 191 | 🐛 7 | 🌐 Zig | 📅 2026-09-17 - Flake for packaging, building and running Zig projects.
...
* [Home Manager](https://github.com/nix-community/home-manager) ⭐ 10,354 | 🐛 988 | 🌐 Nix | 📅 2026-09-17 - Manage your user configuration just like NixOS.
* [nix-darwin](https://github.com/nix-darwin/nix-darwin) ⭐ 5,935 | 🐛 479 | 🌐 Nix | 📅 2026-08-16 - Manage macOS configuration just like on NixOS.
* [NixOS hardware](https://github.com/NixOS/nixos-hardware) ⭐ 3,302 | 🐛 323 | 🌐 Nix | 📅 2026-09-17 - NixOS profiles to optimize settings for different hardware.
...
* [Nixvim](https://github.com/nix-community/nixvim) ⭐ 2,947 | 🐛 161 | 🌐 Nix | 📅 2026-09-17 - A pre-packaged Neovim distribution built with Nix modules and Nixpkgs.
* [Stylix](https://github.com/nix-community/stylix) ⭐ 2,406 | 🐛 290 | 🌐 Nix | 📅 2026-09-01 - System-wide colorscheming and typography for NixOS.
* [impermanence](https://github.com/nix-community/impermanence) ⭐ 1,890 | 🐛 106 | 🌐 Nix | 📅 2026-01-27 - Lets you choose what files and directories you want to keep between reboots.
...
* [Self Host Blocks](https://github.com/ibizaman/selfhostblocks) ⭐ 498 | 🐛 118 | 🌐 Nix | 📅 2026-09-17 - Modular server management based on NixOS modules and focused on best practices.
...
* [Nix Software Center](https://github.com/snowfallorg/nix-software-center) ⭐ 850 | 🐛 59 | 🌐 Rust | 📅 2026-04-07 - Install and manage Nix packages. Desktop app in Rust and GTK.
* [NixOS Configuration Editor](https://github.com/snowfallorg/nixos-conf-editor) ⭐ 679 | 🐛 13 | 🌐 Rust | 📅 2026-02-15 - Graphical editor for NixOS configuration. Desktop app in Rust and GTK.
...
* [NUR](https://github.com/nix-community/NUR/) ⭐ 1,951 | 🐛 36 | 🌐 Python | 📅 2026-09-17 - Nix User Repositories. The mother of all overlays, allowing access to user repositories and installing packages via attributes.
* [System Manager](https://github.com/numtide/system-manager) ⭐ 1,731 | 🐛 65 | 🌐 Nix | 📅 2026-09-16 - A non-NixOS Linux system configuration tool built on Nix.
* [rust-overlay](https://github.com/oxalica/rust-overlay) ⭐ 1,557 | 🐛 23 | 🌐 Nix | 📅 2026-09-17 - Pure and reproducible nix overlay of binary distributed Rust toolchains.
* [nixpkgs-wayland](https://github.com/nix-community/nixpkgs-wayland) ⭐ 628 | 🐛 56 | 🌐 Nix | 📅 2026-09-17 - Bleeding-edge Wayland packages.
* [nixpkgs-mozilla](https://github.com/mozilla/nixpkgs-mozilla) ⚠️ Archived - Mozilla's overlay with Rust toolchains and Firefox.
* [zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 548 | 🐛 10 | 🌐 Nix | 📅 2026-09-17 - A Nix flake packaging the Zig compiler. The flake mirrors the binaries built officially by Zig and does not build them from source.
* [neovim-nightly-overlay](https://github.com/nix-community/neovim-nightly-overlay) ⭐ 417 | 🐛 1 | 🌐 Nix | 📅 2026-09-17 - Daily bumped Neovim nightly package.
* [awesome-nix-hpc](https://github.com/freuk/awesome-nix-hpc) ⭐ 102 | 🐛 0 | 📅 2025-04-22 - High Performance Computing package sets.
* [nixpkgs-firefox-darwin](https://github.com/bandithedoge/nixpkgs-firefox-darwin) ⭐ 74 | 🐛 3 | 🌐 Nix | 📅 2026-09-17 - Automatically updated Firefox binary packages for macOS.
