...
[Nix](https://github.com/nixos/nix) ⭐ 17,650 | 🐛 2,946 | 🌐 C++ | 📅 2026-09-06 is a powerful package manager for Linux and other Unix systems that makes package management reliable and reproducible.
...
* [NixOS & Flakes Book](https://github.com/ryan4yin/nixos-and-flakes-book) ⭐ 3,272 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-05 - An unofficial and opinionated NixOS & Flakes book for beginners.
...
* [NüschtOS Search](https://github.com/NuschtOS/search) ⭐ 166 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-06 - Simple and fast static-page NixOS option search.
...
* [nixos-anywhere](https://github.com/nix-community/nixos-anywhere) ⭐ 3,431 | 🐛 107 | 🌐 Shell | 📅 2026-09-02 - Install NixOS everywhere via SSH.
...
* [nixos-infect](https://github.com/elitak/nixos-infect) ⭐ 1,925 | 🐛 76 | 🌐 Shell | 📅 2026-03-22 - Replace a running non-NixOS Linux host with NixOS.
...
* [Colmena](https://github.com/nix-community/colmena) ⭐ 2,336 | 🐛 146 | 🌐 Rust | 📅 2026-08-20 - A simple, stateless NixOS deployment tool modeled after NixOps and morph.
* [deploy-rs](https://github.com/serokell/deploy-rs) ⭐ 2,304 | 🐛 134 | 🌐 Rust | 📅 2026-09-03 - A simple multi-profile Nix-flake deploy tool.
...
* [comin](https://github.com/nlewo/comin) ⭐ 1,001 | 🐛 47 | 🌐 Go | 📅 2026-08-28 - A deployment tool to continuously pull from Git repositories.
...
* [microvm](https://github.com/microvm-nix/microvm.nix) ⭐ 2,908 | 🐛 58 | 🌐 Nix | 📅 2026-09-05 - NixOS-based MicroVMs.
* [nixos-shell](https://github.com/Mic92/nixos-shell) ⭐ 912 | 🐛 13 | 🌐 Nix | 📅 2026-06-30 - Simple headless VM configuration using Nix (similar to Vagrant).
...
* [agent-sandbox.nix](https://github.com/archie-judd/agent-sandbox.nix) ⭐ 150 | 🐛 12 | 🌐 Shell | 📅 2026-09-06 - Declarative sandboxing for any package (e.g. AI coding agents) using bubblewrap on Linux and sandbox-exec on macOS.

## Command-Line Tools

* [devenv](https://github.com/cachix/devenv) ⭐ 7,534 | 🐛 370 | 🌐 Rust | 📅 2026-09-06 - A Nix-based tool for creating developer shell environments quickly and reproducibly.
* [nh](https://github.com/nix-community/nh) ⭐ 3,182 | 🐛 82 | 🌐 Rust | 📅 2026-09-06 - Better output for `nix`, `nixos-rebuild`, `home-manager` and nix-darwin CLI leveraging `dix` and `nix-output-monitor`.
* [comma](https://github.com/nix-community/comma) ⭐ 1,755 | 🐛 11 | 🌐 Rust | 📅 2026-09-01 - Quickly run any binary; wraps together `nix run` and `nix-index`.
* [nix-output-monitor](https://github.com/maralorn/nix-output-monitor) ⭐ 1,651 | 🐛 107 | 🌐 Haskell | 📅 2026-08-28 - A tool to produce useful graphs and statistics when building derivations.
* [nixfmt](https://github.com/NixOS/nixfmt) ⭐ 1,599 | 🐛 23 | 🌐 Haskell | 📅 2026-09-02 - A formatter for Nix code, intended to easily apply a uniform style.
* [nix-init](https://github.com/nix-community/nix-init) ⭐ 1,462 | 🐛 28 | 🌐 Rust | 📅 2026-09-04 - Generate Nix packages from URLs with hash prefetching, dependency inference, license detection, and more.
* [alejandra](https://github.com/kamadorueda/alejandra) ⭐ 1,397 | 🐛 66 | 🌐 Nix | 📅 2026-04-25 - An opinionated Nix code formatter optimized for speed and consistency.
* [nix-index](https://github.com/nix-community/nix-index) ⭐ 1,352 | 🐛 99 | 🌐 Rust | 📅 2026-09-01 - Quickly locate Nix packages with specific files.
...
* [nurl](https://github.com/nix-community/nurl) ⭐ 782 | 🐛 16 | 🌐 Rust | 📅 2026-09-05 - Generate Nix fetcher calls from repository URLs.
...
* [dix](https://github.com/manic-systems/dix) ⭐ 345 | 🐛 9 | 🌐 Rust | 📅 2026-08-31 - Diff Nix; a super-fast tool to diff Nix related things.
...
* [angrr](https://github.com/linyinfeng/angrr) ⭐ 143 | 🐛 6 | 🌐 Rust | 📅 2026-09-04 - Auto Nix GC Roots Retention. This tool simply deletes auto GC roots based on the modified time of their symbolic link target.
...
* [Devbox](https://github.com/jetify-com/devbox) ⭐ 12,335 | 🐛 496 | 🌐 Go | 📅 2026-09-04 - Instant, portable, and predictable development environments.
* [flox](https://github.com/flox/flox) ⭐ 4,121 | 🐛 444 | 🌐 Rust | 📅 2026-09-06 - Manage and share development environments, package projects, and publish artifacts anywhere.
...
* [attic](https://github.com/zhaofengli/attic) ⭐ 2,052 | 🐛 167 | 🌐 Rust | 📅 2026-09-02 - Multi-tenant Nix Binary Cache.
...
* [nixd](https://github.com/nix-community/nixd) ⭐ 1,480 | 🐛 105 | 🌐 C++ | 📅 2026-09-03 - Nix language server, based on Nix libraries.
...
* [nix2container](https://github.com/nlewo/nix2container) ⭐ 904 | 🐛 90 | 🌐 Go | 📅 2026-09-06 - An efficient container building workflow with Nix.
* [compose2nix](https://github.com/aksiksi/compose2nix) ⭐ 894 | 🐛 13 | 🌐 Go | 📅 2026-08-25 - Generate a NixOS config from a Docker Compose project.
...
* [nix-update](https://github.com/Mic92/nix-update) ⭐ 871 | 🐛 52 | 🌐 Python | 📅 2026-09-06 - Update versions/source hashes of nix packages.
* [pre-commit-hooks.nix](https://github.com/cachix/git-hooks.nix) ⭐ 861 | 🐛 93 | 🌐 Nix | 📅 2026-09-01 - Run linters/formatters at commit time and on your CI.
* [MCP-NixOS](https://github.com/utensils/mcp-nixos) ⭐ 825 | 🐛 0 | 🌐 Python | 📅 2026-09-05 - An MCP server that provides AI assistants with accurate information about NixOS packages, options, Home Manager, and nix-darwin configurations.
* [robotnix](https://github.com/nix-community/robotnix) ⭐ 805 | 🐛 81 | 🌐 Nix | 📅 2026-09-05 - A declarative and reproducible build system for Android (AOSP) images.
...
* [treefmt-nix](https://github.com/numtide/treefmt-nix) ⭐ 645 | 🐛 94 | 🌐 Nix | 📅 2026-08-16 - A formatter that allows formatting all your project files with a single command, all via a single `.nix` file.
...
* [npins](https://github.com/andir/npins) ⭐ 564 | 🐛 33 | 🌐 Rust | 📅 2026-09-02 - A simple tool for handling different types of dependencies in a Nix project. It is inspired by and comparable to Niv.
...
* [flakelight](https://github.com/nix-community/flakelight) ⭐ 410 | 🐛 4 | 🌐 Nix | 📅 2026-09-05 - A modular flake framework aiming to minimize boilerplate.
...
* [flake-edit](https://github.com/a-kenji/flake-edit) ⭐ 83 | 🐛 9 | 🌐 Rust | 📅 2026-08-24 - Edit your flake inputs with auto-follows and update functionality directly from the CLI.
...
* [nixidy](https://github.com/arnarg/nixidy) ⭐ 384 | 🐛 3 | 🌐 Nix | 📅 2026-08-14 - Kubernetes GitOps with Nix and Argo CD.
...
* [haskell.nix](https://github.com/input-output-hk/haskell.nix) ⭐ 632 | 🐛 105 | 🌐 Nix | 📅 2026-09-06 - Alternative Haskell Infrastructure for Nixpkgs.
...
* [poetry2nix](https://github.com/nix-community/poetry2nix) ⭐ 929 | 🐛 188 | 🌐 Nix | 📅 2026-09-06 - Build Python packages directly from [Poetry's](https://python-poetry.org/) `poetry.lock`. No conversion step needed.
...
* [fenix](https://github.com/nix-community/fenix) ⭐ 1,116 | 🐛 38 | 🌐 Nix | 📅 2026-09-06 - Rust toolchains and Rust analyzer nightly for nix.
...
* [nix-cargo-integration](https://github.com/90-008/nix-cargo-integration) ⭐ 217 | 🐛 5 | 🌐 Nix | 📅 2026-09-06 - A library that allows easy and effortless integration for Cargo projects.
...
* [zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 190 | 🐛 6 | 🌐 Zig | 📅 2026-09-06 - Flake for packaging, building and running Zig projects.
...
* [Home Manager](https://github.com/nix-community/home-manager) ⭐ 10,326 | 🐛 1,004 | 🌐 Nix | 📅 2026-09-06 - Manage your user configuration just like NixOS.
* [nix-darwin](https://github.com/nix-darwin/nix-darwin) ⭐ 5,905 | 🐛 475 | 🌐 Nix | 📅 2026-08-16 - Manage macOS configuration just like on NixOS.
* [NixOS hardware](https://github.com/NixOS/nixos-hardware) ⭐ 3,295 | 🐛 323 | 🌐 Nix | 📅 2026-09-03 - NixOS profiles to optimize settings for different hardware.
* [NixOS-WSL](https://github.com/nix-community/NixOS-WSL) ⭐ 3,081 | 🐛 54 | 🌐 Nix | 📅 2026-09-02 - Modules for running NixOS on the Windows Subsystem for Linux.
* [Nixvim](https://github.com/nix-community/nixvim) ⭐ 2,942 | 🐛 160 | 🌐 Nix | 📅 2026-09-06 - A pre-packaged Neovim distribution built with Nix modules and Nixpkgs.
* [Stylix](https://github.com/nix-community/stylix) ⭐ 2,394 | 🐛 282 | 🌐 Nix | 📅 2026-09-01 - System-wide colorscheming and typography for NixOS.
...
* [nvf](https://github.com/NotAShelf/nvf) ⭐ 1,624 | 🐛 128 | 🌐 Nix | 📅 2026-09-04 - A portable, modular Neovim configuration framework for Nix.
* [nix-topology](https://github.com/oddlama/nix-topology) ⭐ 993 | 🐛 22 | 🌐 Nix | 📅 2026-06-22 - Generate infrastructure and network diagrams directly from your NixOS configuration.
* [musnix](https://github.com/musnix/musnix) ⭐ 943 | 🐛 14 | 🌐 Nix | 📅 2026-09-01 - Do real-time audio work in NixOS.
...
* [Self Host Blocks](https://github.com/ibizaman/selfhostblocks) ⭐ 495 | 🐛 126 | 🌐 Nix | 📅 2026-09-06 - Modular server management based on NixOS modules and focused on best practices.
...
* [NUR](https://github.com/nix-community/NUR/) ⭐ 1,946 | 🐛 38 | 🌐 Python | 📅 2026-09-06 - Nix User Repositories. The mother of all overlays, allowing access to user repositories and installing packages via attributes.
* [System Manager](https://github.com/numtide/system-manager) ⭐ 1,714 | 🐛 60 | 🌐 Nix | 📅 2026-09-05 - A non-NixOS Linux system configuration tool built on Nix.
* [rust-overlay](https://github.com/oxalica/rust-overlay) ⭐ 1,555 | 🐛 23 | 🌐 Nix | 📅 2026-09-06 - Pure and reproducible nix overlay of binary distributed Rust toolchains.
* [nixpkgs-wayland](https://github.com/nix-community/nixpkgs-wayland) ⭐ 629 | 🐛 55 | 🌐 Nix | 📅 2026-09-06 - Bleeding-edge Wayland packages.
* [nixpkgs-mozilla](https://github.com/mozilla/nixpkgs-mozilla) ⚠️ Archived - Mozilla's overlay with Rust toolchains and Firefox.
* [zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 543 | 🐛 10 | 🌐 Nix | 📅 2026-09-06 - A Nix flake packaging the Zig compiler. The flake mirrors the binaries built officially by Zig and does not build them from source.
* [neovim-nightly-overlay](https://github.com/nix-community/neovim-nightly-overlay) ⭐ 417 | 🐛 1 | 🌐 Nix | 📅 2026-09-06 - Daily bumped Neovim nightly package.
* [awesome-nix-hpc](https://github.com/freuk/awesome-nix-hpc) ⭐ 102 | 🐛 0 | 📅 2025-04-22 - High Performance Computing package sets.
* [nixpkgs-firefox-darwin](https://github.com/bandithedoge/nixpkgs-firefox-darwin) ⭐ 74 | 🐛 3 | 🌐 Nix | 📅 2026-09-05 - Automatically updated Firefox binary packages for macOS.
