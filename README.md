...
[Nix](https://github.com/nixos/nix) ⭐ 17,595 | 🐛 2,941 | 🌐 C++ | 📅 2026-08-30 is a powerful package manager for Linux and other Unix systems that makes package management reliable and reproducible.
...
* [Nix Starter Config](https://github.com/Misterio77/nix-starter-configs) ⭐ 3,820 | 🐛 16 | 🌐 Nix | 📅 2026-04-24 - A few simple Nix Flake templates for getting started with NixOS + home-manager.
* [NixOS & Flakes Book](https://github.com/ryan4yin/nixos-and-flakes-book) ⭐ 3,267 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-05 - An unofficial and opinionated NixOS & Flakes book for beginners.
...
* [nix-installer](https://github.com/DeterminateSystems/nix-installer) ⭐ 3,678 | 🐛 438 | 🌐 Rust | 📅 2026-08-30 - Opinionated alternative to the official Nix install scripts.
* [nixos-anywhere](https://github.com/nix-community/nixos-anywhere) ⭐ 3,414 | 🐛 104 | 🌐 Shell | 📅 2026-08-26 - Install NixOS everywhere via SSH.
...
* [Colmena](https://github.com/nix-community/colmena) ⭐ 2,329 | 🐛 146 | 🌐 Rust | 📅 2026-08-20 - A simple, stateless NixOS deployment tool modeled after NixOps and morph.
* [deploy-rs](https://github.com/serokell/deploy-rs) ⭐ 2,292 | 🐛 143 | 🌐 Rust | 📅 2026-08-24 - A simple multi-profile Nix-flake deploy tool.
* [NixOps](https://github.com/NixOS/nixops) ⭐ 2,195 | 🐛 327 | 🌐 Python | 📅 2025-12-28 - The official Nix deployment tool, compatible with AWS, Hetzner, and more.
...
* [comin](https://github.com/nlewo/comin) ⭐ 992 | 🐛 44 | 🌐 Go | 📅 2026-08-28 - A deployment tool to continuously pull from Git repositories.
...
* [microvm](https://github.com/microvm-nix/microvm.nix) ⭐ 2,896 | 🐛 56 | 🌐 Nix | 📅 2026-08-30 - NixOS-based MicroVMs.
...
* [devenv](https://github.com/cachix/devenv) ⭐ 7,455 | 🐛 361 | 🌐 Rust | 📅 2026-08-30 - A Nix-based tool for creating developer shell environments quickly and reproducibly.
* [nh](https://github.com/nix-community/nh) ⭐ 3,160 | 🐛 83 | 🌐 Rust | 📅 2026-08-29 - Better output for `nix`, `nixos-rebuild`, `home-manager` and nix-darwin CLI leveraging `dix` and `nix-output-monitor`.
...
* [nix-output-monitor](https://github.com/maralorn/nix-output-monitor) ⭐ 1,648 | 🐛 105 | 🌐 Haskell | 📅 2026-08-28 - A tool to produce useful graphs and statistics when building derivations.
...
* [nix-init](https://github.com/nix-community/nix-init) ⭐ 1,461 | 🐛 27 | 🌐 Rust | 📅 2026-08-30 - Generate Nix packages from URLs with hash prefetching, dependency inference, license detection, and more.
...
* [nix-index](https://github.com/nix-community/nix-index) ⭐ 1,351 | 🐛 99 | 🌐 Rust | 📅 2026-08-16 - Quickly locate Nix packages with specific files.
...
* [statix](https://github.com/oppiliappan/statix) ⭐ 941 | 🐛 46 | 🌐 Rust | 📅 2026-07-26 - A linter/fixer to check for and fix antipatterns in Nix code.
* [nix-alien](https://github.com/thiagokokada/nix-alien) ⭐ 869 | 🐛 1 | 🌐 Python | 📅 2026-07-15 - Run unpatched binaries on Nix/NixOS easily.
* [nurl](https://github.com/nix-community/nurl) ⭐ 779 | 🐛 15 | 🌐 Rust | 📅 2026-08-29 - Generate Nix fetcher calls from repository URLs.
...
* [flox](https://github.com/flox/flox) ⭐ 4,110 | 🐛 442 | 🌐 Rust | 📅 2026-08-30 - Manage and share development environments, package projects, and publish artifacts anywhere.
* [nix-direnv](https://github.com/nix-community/nix-direnv) ⭐ 2,767 | 🐛 7 | 🌐 Shell | 📅 2026-08-30 - A fast loader and flake-compliant configuration for the direnv environment auto-loader.
* [attic](https://github.com/zhaofengli/attic) ⭐ 2,039 | 🐛 164 | 🌐 Rust | 📅 2026-08-29 - Multi-tenant Nix Binary Cache.
...
* [nixd](https://github.com/nix-community/nixd) ⭐ 1,471 | 🐛 106 | 🌐 C++ | 📅 2026-08-24 - Nix language server, based on Nix libraries.
* [flake.parts](https://github.com/hercules-ci/flake-parts) ⭐ 1,456 | 🐛 76 | 🌐 Nix | 📅 2026-08-24 - Minimal Nix modules framework for Flakes: split your flakes into modules and get things done with community modules.
...
* [nix-update](https://github.com/Mic92/nix-update) ⭐ 870 | 🐛 54 | 🌐 Python | 📅 2026-08-30 - Update versions/source hashes of nix packages.
...
* [robotnix](https://github.com/nix-community/robotnix) ⭐ 803 | 🐛 82 | 🌐 Nix | 📅 2026-08-23 - A declarative and reproducible build system for Android (AOSP) images.
...
* [treefmt-nix](https://github.com/numtide/treefmt-nix) ⭐ 642 | 🐛 94 | 🌐 Nix | 📅 2026-08-16 - A formatter that allows formatting all your project files with a single command, all via a single `.nix` file.
...
* [npins](https://github.com/andir/npins) ⭐ 563 | 🐛 35 | 🌐 Rust | 📅 2026-08-30 - A simple tool for handling different types of dependencies in a Nix project. It is inspired by and comparable to Niv.
...
* [pog](https://github.com/jpetrucciani/pog) ⭐ 197 | 🐛 3 | 🌐 Nix | 📅 2026-08-06 - A new, powerful way to do bash scripts. Pog is a powerful Nix library that transforms the way developers create command-line interfaces (CLIs).
...
* [haskell.nix](https://github.com/input-output-hk/haskell.nix) ⭐ 632 | 🐛 104 | 🌐 Nix | 📅 2026-08-30 - Alternative Haskell Infrastructure for Nixpkgs.
...
* [poetry2nix](https://github.com/nix-community/poetry2nix) ⭐ 929 | 🐛 188 | 🌐 Nix | 📅 2026-08-30 - Build Python packages directly from [Poetry's](https://python-poetry.org/) `poetry.lock`. No conversion step needed.
* [uv2nix](https://github.com/pyproject-nix/uv2nix) ⭐ 776 | 🐛 2 | 🌐 Nix | 📅 2026-08-29 - Convert [`uv` workspaces](https://docs.astral.sh/uv/concepts/projects/workspaces/) into pure Nix derivations.
...
* [fenix](https://github.com/nix-community/fenix) ⭐ 1,114 | 🐛 38 | 🌐 Nix | 📅 2026-08-30 - Rust toolchains and Rust analyzer nightly for nix.
...
* [nix-cargo-integration](https://github.com/90-008/nix-cargo-integration) ⭐ 217 | 🐛 5 | 🌐 Nix | 📅 2026-08-30 - A library that allows easy and effortless integration for Cargo projects.
...
* [zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 188 | 🐛 6 | 🌐 Zig | 📅 2026-08-30 - Flake for packaging, building and running Zig projects.
...
* [Home Manager](https://github.com/nix-community/home-manager) ⭐ 10,298 | 🐛 1,005 | 🌐 Nix | 📅 2026-08-30 - Manage your user configuration just like NixOS.
* [nix-darwin](https://github.com/nix-darwin/nix-darwin) ⭐ 5,889 | 🐛 474 | 🌐 Nix | 📅 2026-08-16 - Manage macOS configuration just like on NixOS.
* [NixOS hardware](https://github.com/NixOS/nixos-hardware) ⭐ 3,290 | 🐛 313 | 🌐 Nix | 📅 2026-08-29 - NixOS profiles to optimize settings for different hardware.
* [NixOS-WSL](https://github.com/nix-community/NixOS-WSL) ⭐ 3,071 | 🐛 53 | 🌐 Nix | 📅 2026-08-30 - Modules for running NixOS on the Windows Subsystem for Linux.
* [Nixvim](https://github.com/nix-community/nixvim) ⭐ 2,935 | 🐛 157 | 🌐 Nix | 📅 2026-08-30 - A pre-packaged Neovim distribution built with Nix modules and Nixpkgs.
* [Stylix](https://github.com/nix-community/stylix) ⭐ 2,390 | 🐛 277 | 🌐 Nix | 📅 2026-08-26 - System-wide colorscheming and typography for NixOS.
...
* [nvf](https://github.com/NotAShelf/nvf) ⭐ 1,619 | 🐛 125 | 🌐 Nix | 📅 2026-08-27 - A portable, modular Neovim configuration framework for Nix.
* [nix-topology](https://github.com/oddlama/nix-topology) ⭐ 990 | 🐛 20 | 🌐 Nix | 📅 2026-06-22 - Generate infrastructure and network diagrams directly from your NixOS configuration.
...
* [nix-mineral](https://github.com/cynicsketch/nix-mineral) ⭐ 553 | 🐛 41 | 🌐 Nix | 📅 2026-08-30 - Conveniently and reasonably harden NixOS.
* [Self Host Blocks](https://github.com/ibizaman/selfhostblocks) ⭐ 493 | 🐛 124 | 🌐 Nix | 📅 2026-08-30 - Modular server management based on NixOS modules and focused on best practices.
...
* [NUR](https://github.com/nix-community/NUR/) ⭐ 1,941 | 🐛 38 | 🌐 Python | 📅 2026-08-30 - Nix User Repositories. The mother of all overlays, allowing access to user repositories and installing packages via attributes.
* [System Manager](https://github.com/numtide/system-manager) ⭐ 1,702 | 🐛 65 | 🌐 Nix | 📅 2026-08-26 - A non-NixOS Linux system configuration tool built on Nix.
* [rust-overlay](https://github.com/oxalica/rust-overlay) ⭐ 1,553 | 🐛 23 | 🌐 Nix | 📅 2026-08-30 - Pure and reproducible nix overlay of binary distributed Rust toolchains.
* [nixpkgs-wayland](https://github.com/nix-community/nixpkgs-wayland) ⭐ 627 | 🐛 55 | 🌐 Nix | 📅 2026-08-30 - Bleeding-edge Wayland packages.
* [nixpkgs-mozilla](https://github.com/mozilla/nixpkgs-mozilla) ⚠️ Archived - Mozilla's overlay with Rust toolchains and Firefox.
* [zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 542 | 🐛 10 | 🌐 Nix | 📅 2026-08-30 - A Nix flake packaging the Zig compiler. The flake mirrors the binaries built officially by Zig and does not build them from source.
* [neovim-nightly-overlay](https://github.com/nix-community/neovim-nightly-overlay) ⭐ 415 | 🐛 1 | 🌐 Nix | 📅 2026-08-30 - Daily bumped Neovim nightly package.
* [awesome-nix-hpc](https://github.com/freuk/awesome-nix-hpc) ⭐ 102 | 🐛 0 | 📅 2025-04-22 - High Performance Computing package sets.
* [nixpkgs-firefox-darwin](https://github.com/bandithedoge/nixpkgs-firefox-darwin) ⭐ 74 | 🐛 3 | 🌐 Nix | 📅 2026-08-30 - Automatically updated Firefox binary packages for macOS.

## Distributions

* [nixbsd](https://github.com/nixos-bsd/nixbsd) ⭐ 1,032 | 🐛 21 | 🌐 Nix | 📅 2026-07-10 - A NixOS fork with a FreeBSD kernel.
* [NixNG](https://github.com/nix-community/NixNG) ⭐ 496 | 🐛 22 | 🌐 Nix | 📅 2026-08-01 - A GNU/Linux distribution similar to NixOS. The defining difference is a focus on containers and lightweightness.
