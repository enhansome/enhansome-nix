...
[Nix](https://github.com/nixos/nix) ⭐ 17,604 | 🐛 2,940 | 🌐 C++ | 📅 2026-08-31 is a powerful package manager for Linux and other Unix systems that makes package management reliable and reproducible.
...
* [NixOS & Flakes Book](https://github.com/ryan4yin/nixos-and-flakes-book) ⭐ 3,270 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-05 - An unofficial and opinionated NixOS & Flakes book for beginners.
...
* [nix-installer](https://github.com/DeterminateSystems/nix-installer) ⭐ 3,679 | 🐛 439 | 🌐 Rust | 📅 2026-08-30 - Opinionated alternative to the official Nix install scripts.
* [nixos-anywhere](https://github.com/nix-community/nixos-anywhere) ⭐ 3,420 | 🐛 104 | 🌐 Shell | 📅 2026-08-26 - Install NixOS everywhere via SSH.
...
* [Colmena](https://github.com/nix-community/colmena) ⭐ 2,330 | 🐛 146 | 🌐 Rust | 📅 2026-08-20 - A simple, stateless NixOS deployment tool modeled after NixOps and morph.
* [deploy-rs](https://github.com/serokell/deploy-rs) ⭐ 2,296 | 🐛 143 | 🌐 Rust | 📅 2026-08-31 - A simple multi-profile Nix-flake deploy tool.
...
* [comin](https://github.com/nlewo/comin) ⭐ 993 | 🐛 45 | 🌐 Go | 📅 2026-08-28 - A deployment tool to continuously pull from Git repositories.
* [KuberNix](https://github.com/saschagrunert/kubernix) ⭐ 823 | 🐛 1 | 🌐 Rust | 📅 2026-08-31 - Single-dependency Kubernetes clusters via Nix packages.
...
* [microvm](https://github.com/microvm-nix/microvm.nix) ⭐ 2,900 | 🐛 56 | 🌐 Nix | 📅 2026-08-31 - NixOS-based MicroVMs.
...
* [agent-sandbox.nix](https://github.com/archie-judd/agent-sandbox.nix) ⭐ 147 | 🐛 12 | 🌐 Shell | 📅 2026-08-28 - Declarative sandboxing for any package (e.g. AI coding agents) using bubblewrap on Linux and sandbox-exec on macOS.

## Command-Line Tools

* [devenv](https://github.com/cachix/devenv) ⭐ 7,464 | 🐛 364 | 🌐 Rust | 📅 2026-08-31 - A Nix-based tool for creating developer shell environments quickly and reproducibly.
...
* [comma](https://github.com/nix-community/comma) ⭐ 1,751 | 🐛 12 | 🌐 Rust | 📅 2026-08-31 - Quickly run any binary; wraps together `nix run` and `nix-index`.
...
* [nix-init](https://github.com/nix-community/nix-init) ⭐ 1,462 | 🐛 26 | 🌐 Rust | 📅 2026-08-31 - Generate Nix packages from URLs with hash prefetching, dependency inference, license detection, and more.
...
* [nix-tree](https://github.com/utdemir/nix-tree) ⭐ 1,066 | 🐛 20 | 🌐 Haskell | 📅 2026-08-01 - Interactively browse the dependency graph of Nix derivations.
...
* [nix-alien](https://github.com/thiagokokada/nix-alien) ⭐ 870 | 🐛 1 | 🌐 Python | 📅 2026-07-15 - Run unpatched binaries on Nix/NixOS easily.
* [nurl](https://github.com/nix-community/nurl) ⭐ 781 | 🐛 15 | 🌐 Rust | 📅 2026-08-31 - Generate Nix fetcher calls from repository URLs.
* [deadnix](https://github.com/astro/deadnix) ⭐ 776 | 🐛 5 | 🌐 Rust | 📅 2026-07-26 - Scan Nix files for dead code.
...
* [Devbox](https://github.com/jetify-com/devbox) ⭐ 12,320 | 🐛 497 | 🌐 Go | 📅 2026-08-18 - Instant, portable, and predictable development environments.
* [flox](https://github.com/flox/flox) ⭐ 4,112 | 🐛 443 | 🌐 Rust | 📅 2026-08-31 - Manage and share development environments, package projects, and publish artifacts anywhere.
...
* [attic](https://github.com/zhaofengli/attic) ⭐ 2,042 | 🐛 164 | 🌐 Rust | 📅 2026-08-29 - Multi-tenant Nix Binary Cache.
...
* [devshell](https://github.com/numtide/devshell) ⭐ 1,550 | 🐛 98 | 🌐 Nix | 📅 2026-06-18 - `mkShell` with extra bits and a toml config option to be able to onboard non-nix users.
* [nixd](https://github.com/nix-community/nixd) ⭐ 1,473 | 🐛 105 | 🌐 C++ | 📅 2026-08-31 - Nix language server, based on Nix libraries.
* [flake.parts](https://github.com/hercules-ci/flake-parts) ⭐ 1,458 | 🐛 76 | 🌐 Nix | 📅 2026-08-24 - Minimal Nix modules framework for Flakes: split your flakes into modules and get things done with community modules.
...
* [nix-update](https://github.com/Mic92/nix-update) ⭐ 871 | 🐛 54 | 🌐 Python | 📅 2026-08-30 - Update versions/source hashes of nix packages.
...
* [MCP-NixOS](https://github.com/utensils/mcp-nixos) ⭐ 813 | 🐛 2 | 🌐 Python | 📅 2026-08-12 - An MCP server that provides AI assistants with accurate information about NixOS packages, options, Home Manager, and nix-darwin configurations.
...
* [treefmt-nix](https://github.com/numtide/treefmt-nix) ⭐ 643 | 🐛 94 | 🌐 Nix | 📅 2026-08-16 - A formatter that allows formatting all your project files with a single command, all via a single `.nix` file.
* [nixpkgs-review](https://github.com/Mic92/nixpkgs-review) ⭐ 637 | 🐛 84 | 🌐 Python | 📅 2026-08-31 - The best tool to verify that a pull-request in Nixpkgs is building properly.
...
* [haskell.nix](https://github.com/input-output-hk/haskell.nix) ⭐ 632 | 🐛 104 | 🌐 Nix | 📅 2026-08-31 - Alternative Haskell Infrastructure for Nixpkgs.
...
* [Easy PureScript Nix](https://github.com/justinwoo/easy-purescript-nix) ⭐ 212 | 🐛 8 | 🌐 Nix | 📅 2025-11-22 - A project to easily use PureScript and other tools with Nix.
...
* [poetry2nix](https://github.com/nix-community/poetry2nix) ⭐ 929 | 🐛 188 | 🌐 Nix | 📅 2026-08-31 - Build Python packages directly from [Poetry's](https://python-poetry.org/) `poetry.lock`. No conversion step needed.
...
* [fenix](https://github.com/nix-community/fenix) ⭐ 1,115 | 🐛 38 | 🌐 Nix | 📅 2026-08-31 - Rust toolchains and Rust analyzer nightly for nix.
* [naersk](https://github.com/nix-community/naersk) ⭐ 1,006 | 🐛 65 | 🌐 Nix | 📅 2026-06-23 - Build Rust packages directly from `Cargo.lock`. No conversion step needed.
...
* [nix-cargo-integration](https://github.com/90-008/nix-cargo-integration) ⭐ 217 | 🐛 5 | 🌐 Nix | 📅 2026-08-31 - A library that allows easy and effortless integration for Cargo projects.
...
* [zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 188 | 🐛 6 | 🌐 Zig | 📅 2026-08-31 - Flake for packaging, building and running Zig projects.
...
* [Home Manager](https://github.com/nix-community/home-manager) ⭐ 10,300 | 🐛 1,010 | 🌐 Nix | 📅 2026-08-31 - Manage your user configuration just like NixOS.
* [nix-darwin](https://github.com/nix-darwin/nix-darwin) ⭐ 5,892 | 🐛 475 | 🌐 Nix | 📅 2026-08-16 - Manage macOS configuration just like on NixOS.
...
* [Nixvim](https://github.com/nix-community/nixvim) ⭐ 2,934 | 🐛 157 | 🌐 Nix | 📅 2026-08-31 - A pre-packaged Neovim distribution built with Nix modules and Nixpkgs.
* [Stylix](https://github.com/nix-community/stylix) ⭐ 2,391 | 🐛 279 | 🌐 Nix | 📅 2026-08-26 - System-wide colorscheming and typography for NixOS.
...
* [nvf](https://github.com/NotAShelf/nvf) ⭐ 1,622 | 🐛 126 | 🌐 Nix | 📅 2026-08-30 - A portable, modular Neovim configuration framework for Nix.
* [nix-topology](https://github.com/oddlama/nix-topology) ⭐ 991 | 🐛 20 | 🌐 Nix | 📅 2026-06-22 - Generate infrastructure and network diagrams directly from your NixOS configuration.
* [musnix](https://github.com/musnix/musnix) ⭐ 942 | 🐛 14 | 🌐 Nix | 📅 2026-08-01 - Do real-time audio work in NixOS.
* [nix-bitcoin](https://github.com/fort-nix/nix-bitcoin) ⭐ 614 | 🐛 60 | 🌐 Nix | 📅 2026-08-31 - Modules and packages for Bitcoin nodes with higher-layer protocols with an emphasis on security.
* [nix-mineral](https://github.com/cynicsketch/nix-mineral) ⭐ 555 | 🐛 40 | 🌐 Nix | 📅 2026-08-31 - Conveniently and reasonably harden NixOS.
* [Self Host Blocks](https://github.com/ibizaman/selfhostblocks) ⭐ 493 | 🐛 124 | 🌐 Nix | 📅 2026-08-31 - Modular server management based on NixOS modules and focused on best practices.
...
* [NUR](https://github.com/nix-community/NUR/) ⭐ 1,944 | 🐛 39 | 🌐 Python | 📅 2026-08-31 - Nix User Repositories. The mother of all overlays, allowing access to user repositories and installing packages via attributes.
* [System Manager](https://github.com/numtide/system-manager) ⭐ 1,705 | 🐛 65 | 🌐 Nix | 📅 2026-08-31 - A non-NixOS Linux system configuration tool built on Nix.
* [rust-overlay](https://github.com/oxalica/rust-overlay) ⭐ 1,553 | 🐛 23 | 🌐 Nix | 📅 2026-08-31 - Pure and reproducible nix overlay of binary distributed Rust toolchains.
...
* [zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 542 | 🐛 10 | 🌐 Nix | 📅 2026-08-31 - A Nix flake packaging the Zig compiler. The flake mirrors the binaries built officially by Zig and does not build them from source.
* [neovim-nightly-overlay](https://github.com/nix-community/neovim-nightly-overlay) ⭐ 415 | 🐛 1 | 🌐 Nix | 📅 2026-08-31 - Daily bumped Neovim nightly package.
* [awesome-nix-hpc](https://github.com/freuk/awesome-nix-hpc) ⭐ 102 | 🐛 0 | 📅 2025-04-22 - High Performance Computing package sets.
* [nixpkgs-firefox-darwin](https://github.com/bandithedoge/nixpkgs-firefox-darwin) ⭐ 74 | 🐛 3 | 🌐 Nix | 📅 2026-08-31 - Automatically updated Firefox binary packages for macOS.
