...
[Nix](https://github.com/nixos/nix) ⭐ 17,740 | 🐛 2,961 | 🌐 C++ | 📅 2026-09-17 is a powerful package manager for Linux and other Unix systems that makes package management reliable and reproducible.
...
* [NixOS & Flakes Book](https://github.com/ryan4yin/nixos-and-flakes-book) ⭐ 3,293 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-05 - An unofficial and opinionated NixOS & Flakes book for beginners.
...
* [nix-installer](https://github.com/DeterminateSystems/nix-installer) ⭐ 3,688 | 🐛 439 | 🌐 Rust | 📅 2026-09-17 - Opinionated alternative to the official Nix install scripts.
* [nixos-anywhere](https://github.com/nix-community/nixos-anywhere) ⭐ 3,448 | 🐛 104 | 🌐 Shell | 📅 2026-09-16 - Install NixOS everywhere via SSH.
...
* [Colmena](https://github.com/nix-community/colmena) ⭐ 2,345 | 🐛 147 | 🌐 Rust | 📅 2026-09-17 - A simple, stateless NixOS deployment tool modeled after NixOps and morph.
...
* [comin](https://github.com/nlewo/comin) ⭐ 1,019 | 🐛 44 | 🌐 Go | 📅 2026-09-16 - A deployment tool to continuously pull from Git repositories.
...
* [nixos-shell](https://github.com/Mic92/nixos-shell) ⭐ 915 | 🐛 13 | 🌐 Nix | 📅 2026-09-17 - Simple headless VM configuration using Nix (similar to Vagrant).
...
* [agent-sandbox.nix](https://github.com/archie-judd/agent-sandbox.nix) ⭐ 158 | 🐛 2 | 🌐 Shell | 📅 2026-09-18 - Declarative sandboxing for any package (e.g. AI coding agents) using bubblewrap on Linux and sandbox-exec on macOS.

## Command-Line Tools

* [devenv](https://github.com/cachix/devenv) ⭐ 7,658 | 🐛 369 | 🌐 Rust | 📅 2026-09-18 - A Nix-based tool for creating developer shell environments quickly and reproducibly.
* [nh](https://github.com/nix-community/nh) ⭐ 3,211 | 🐛 83 | 🌐 Rust | 📅 2026-09-16 - Better output for `nix`, `nixos-rebuild`, `home-manager` and nix-darwin CLI leveraging `dix` and `nix-output-monitor`.
* [comma](https://github.com/nix-community/comma) ⭐ 1,767 | 🐛 11 | 🌐 Rust | 📅 2026-09-01 - Quickly run any binary; wraps together `nix run` and `nix-index`.
...
* [nixfmt](https://github.com/NixOS/nixfmt) ⭐ 1,607 | 🐛 20 | 🌐 Haskell | 📅 2026-09-15 - A formatter for Nix code, intended to easily apply a uniform style.
...
* [nix-melt](https://github.com/nix-community/nix-melt) ⭐ 315 | 🐛 5 | 🌐 Rust | 📅 2026-09-08 - A ranger-like flake.lock viewer.
...
* [Devbox](https://github.com/jetify-com/devbox) ⭐ 12,366 | 🐛 414 | 🌐 Go | 📅 2026-09-17 - Instant, portable, and predictable development environments.
* [flox](https://github.com/flox/flox) ⭐ 4,129 | 🐛 437 | 🌐 Rust | 📅 2026-09-18 - Manage and share development environments, package projects, and publish artifacts anywhere.
* [nix-direnv](https://github.com/nix-community/nix-direnv) ⭐ 2,780 | 🐛 7 | 🌐 Shell | 📅 2026-09-18 - A fast loader and flake-compliant configuration for the direnv environment auto-loader.
* [attic](https://github.com/zhaofengli/attic) ⭐ 2,076 | 🐛 174 | 🌐 Rust | 📅 2026-09-16 - Multi-tenant Nix Binary Cache.
* [nil](https://github.com/oxalica/nil) ⭐ 1,912 | 🐛 34 | 🌐 Rust | 📅 2026-07-26 - NIx Language server, an incremental analysis assistent for writing in Nix.
...
* [nixd](https://github.com/nix-community/nixd) ⭐ 1,488 | 🐛 105 | 🌐 C++ | 📅 2026-09-14 - Nix language server, based on Nix libraries.
...
* [nix2container](https://github.com/nlewo/nix2container) ⭐ 911 | 🐛 98 | 🌐 Go | 📅 2026-09-07 - An efficient container building workflow with Nix.
...
* [MCP-NixOS](https://github.com/utensils/mcp-nixos) ⭐ 837 | 🐛 0 | 🌐 Python | 📅 2026-09-05 - An MCP server that provides AI assistants with accurate information about NixOS packages, options, Home Manager, and nix-darwin configurations.
...
* [poetry2nix](https://github.com/nix-community/poetry2nix) ⭐ 929 | 🐛 188 | 🌐 Nix | 📅 2026-09-18 - Build Python packages directly from [Poetry's](https://python-poetry.org/) `poetry.lock`. No conversion step needed.
...
* [fenix](https://github.com/nix-community/fenix) ⭐ 1,119 | 🐛 40 | 🌐 Nix | 📅 2026-09-18 - Rust toolchains and Rust analyzer nightly for nix.
...
* [nix-cargo-integration](https://github.com/90-008/nix-cargo-integration) ⭐ 217 | 🐛 5 | 🌐 Nix | 📅 2026-09-18 - A library that allows easy and effortless integration for Cargo projects.
...
* [zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 191 | 🐛 7 | 🌐 Zig | 📅 2026-09-18 - Flake for packaging, building and running Zig projects.
...
* [Home Manager](https://github.com/nix-community/home-manager) ⭐ 10,357 | 🐛 987 | 🌐 Nix | 📅 2026-09-18 - Manage your user configuration just like NixOS.
* [nix-darwin](https://github.com/nix-darwin/nix-darwin) ⭐ 5,937 | 🐛 479 | 🌐 Nix | 📅 2026-08-16 - Manage macOS configuration just like on NixOS.
* [NixOS hardware](https://github.com/NixOS/nixos-hardware) ⭐ 3,303 | 🐛 320 | 🌐 Nix | 📅 2026-09-18 - NixOS profiles to optimize settings for different hardware.
...
* [Nixvim](https://github.com/nix-community/nixvim) ⭐ 2,949 | 🐛 160 | 🌐 Nix | 📅 2026-09-18 - A pre-packaged Neovim distribution built with Nix modules and Nixpkgs.
* [Stylix](https://github.com/nix-community/stylix) ⭐ 2,407 | 🐛 291 | 🌐 Nix | 📅 2026-09-01 - System-wide colorscheming and typography for NixOS.
...
* [Self Host Blocks](https://github.com/ibizaman/selfhostblocks) ⭐ 499 | 🐛 119 | 🌐 Nix | 📅 2026-09-18 - Modular server management based on NixOS modules and focused on best practices.
...
* [NUR](https://github.com/nix-community/NUR/) ⭐ 1,951 | 🐛 37 | 🌐 Python | 📅 2026-09-18 - Nix User Repositories. The mother of all overlays, allowing access to user repositories and installing packages via attributes.
* [System Manager](https://github.com/numtide/system-manager) ⭐ 1,732 | 🐛 66 | 🌐 Nix | 📅 2026-09-16 - A non-NixOS Linux system configuration tool built on Nix.
* [rust-overlay](https://github.com/oxalica/rust-overlay) ⭐ 1,559 | 🐛 23 | 🌐 Nix | 📅 2026-09-18 - Pure and reproducible nix overlay of binary distributed Rust toolchains.
* [nixpkgs-wayland](https://github.com/nix-community/nixpkgs-wayland) ⭐ 628 | 🐛 56 | 🌐 Nix | 📅 2026-09-18 - Bleeding-edge Wayland packages.
* [nixpkgs-mozilla](https://github.com/mozilla/nixpkgs-mozilla) ⚠️ Archived - Mozilla's overlay with Rust toolchains and Firefox.
* [zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 548 | 🐛 10 | 🌐 Nix | 📅 2026-09-18 - A Nix flake packaging the Zig compiler. The flake mirrors the binaries built officially by Zig and does not build them from source.
* [neovim-nightly-overlay](https://github.com/nix-community/neovim-nightly-overlay) ⭐ 418 | 🐛 1 | 🌐 Nix | 📅 2026-09-18 - Daily bumped Neovim nightly package.
* [awesome-nix-hpc](https://github.com/freuk/awesome-nix-hpc) ⭐ 102 | 🐛 0 | 📅 2025-04-22 - High Performance Computing package sets.
* [nixpkgs-firefox-darwin](https://github.com/bandithedoge/nixpkgs-firefox-darwin) ⭐ 74 | 🐛 3 | 🌐 Nix | 📅 2026-09-18 - Automatically updated Firefox binary packages for macOS.
