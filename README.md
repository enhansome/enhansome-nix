...
[Nix](https://github.com/nixos/nix) ⭐ 17,656 | 🐛 2,946 | 🌐 C++ | 📅 2026-09-07 is a powerful package manager for Linux and other Unix systems that makes package management reliable and reproducible.
...
* [NixOS & Flakes Book](https://github.com/ryan4yin/nixos-and-flakes-book) ⭐ 3,275 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-05 - An unofficial and opinionated NixOS & Flakes book for beginners.
...
* [NüschtOS Search](https://github.com/NuschtOS/search) ⭐ 167 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-06 - Simple and fast static-page NixOS option search.
...
* [nix-installer](https://github.com/DeterminateSystems/nix-installer) ⭐ 3,681 | 🐛 440 | 🌐 Rust | 📅 2026-09-06 - Opinionated alternative to the official Nix install scripts.
* [nixos-anywhere](https://github.com/nix-community/nixos-anywhere) ⭐ 3,433 | 🐛 107 | 🌐 Shell | 📅 2026-09-02 - Install NixOS everywhere via SSH.
...
* [`npc`](https://github.com/samestep/npc) ⭐ 99 | 🐛 6 | 🌐 Rust | 📅 2026-08-23 - CLI to view and bisect Nixpkgs channel history.
...
* [deploy-rs](https://github.com/serokell/deploy-rs) ⭐ 2,306 | 🐛 134 | 🌐 Rust | 📅 2026-09-07 - A simple multi-profile Nix-flake deploy tool.
...
* [comin](https://github.com/nlewo/comin) ⭐ 1,004 | 🐛 47 | 🌐 Go | 📅 2026-08-28 - A deployment tool to continuously pull from Git repositories.
* [KuberNix](https://github.com/saschagrunert/kubernix) ⭐ 824 | 🐛 0 | 🌐 Rust | 📅 2026-09-03 - Single-dependency Kubernetes clusters via Nix packages.
* [KubeNix](https://github.com/hall/kubenix) ⭐ 514 | 🐛 27 | 🌐 Nix | 📅 2026-09-06 - A Kubernetes resource builder using Nix.
...
* [microvm](https://github.com/microvm-nix/microvm.nix) ⭐ 2,909 | 🐛 58 | 🌐 Nix | 📅 2026-09-05 - NixOS-based MicroVMs.
* [nixos-shell](https://github.com/Mic92/nixos-shell) ⭐ 913 | 🐛 13 | 🌐 Nix | 📅 2026-06-30 - Simple headless VM configuration using Nix (similar to Vagrant).
...
* [agent-sandbox.nix](https://github.com/archie-judd/agent-sandbox.nix) ⭐ 151 | 🐛 12 | 🌐 Shell | 📅 2026-09-06 - Declarative sandboxing for any package (e.g. AI coding agents) using bubblewrap on Linux and sandbox-exec on macOS.

## Command-Line Tools

* [devenv](https://github.com/cachix/devenv) ⭐ 7,583 | 🐛 354 | 🌐 Rust | 📅 2026-09-07 - A Nix-based tool for creating developer shell environments quickly and reproducibly.
* [nh](https://github.com/nix-community/nh) ⭐ 3,182 | 🐛 83 | 🌐 Rust | 📅 2026-09-07 - Better output for `nix`, `nixos-rebuild`, `home-manager` and nix-darwin CLI leveraging `dix` and `nix-output-monitor`.
* [comma](https://github.com/nix-community/comma) ⭐ 1,756 | 🐛 11 | 🌐 Rust | 📅 2026-09-01 - Quickly run any binary; wraps together `nix run` and `nix-index`.
* [nix-output-monitor](https://github.com/maralorn/nix-output-monitor) ⭐ 1,652 | 🐛 109 | 🌐 Haskell | 📅 2026-08-28 - A tool to produce useful graphs and statistics when building derivations.
* [nixfmt](https://github.com/NixOS/nixfmt) ⭐ 1,600 | 🐛 23 | 🌐 Haskell | 📅 2026-09-02 - A formatter for Nix code, intended to easily apply a uniform style.
...
* [alejandra](https://github.com/kamadorueda/alejandra) ⭐ 1,399 | 🐛 66 | 🌐 Nix | 📅 2026-04-25 - An opinionated Nix code formatter optimized for speed and consistency.
* [nix-index](https://github.com/nix-community/nix-index) ⭐ 1,354 | 🐛 99 | 🌐 Rust | 📅 2026-09-01 - Quickly locate Nix packages with specific files.
* [nix-tree](https://github.com/utdemir/nix-tree) ⭐ 1,067 | 🐛 20 | 🌐 Haskell | 📅 2026-09-01 - Interactively browse the dependency graph of Nix derivations.
...
* [nurl](https://github.com/nix-community/nurl) ⭐ 782 | 🐛 16 | 🌐 Rust | 📅 2026-09-07 - Generate Nix fetcher calls from repository URLs.
...
* [dix](https://github.com/manic-systems/dix) ⭐ 345 | 🐛 9 | 🌐 Rust | 📅 2026-09-07 - Diff Nix; a super-fast tool to diff Nix related things.
...
* [nix-melt](https://github.com/nix-community/nix-melt) ⭐ 313 | 🐛 3 | 🌐 Rust | 📅 2026-09-04 - A ranger-like flake.lock viewer.
* [nix-prefetch](https://github.com/msteen/nix-prefetch) ⭐ 151 | 🐛 23 | 🌐 Shell | 📅 2023-03-06 - A universal tool for updating source checksums.
* [angrr](https://github.com/linyinfeng/angrr) ⭐ 144 | 🐛 6 | 🌐 Rust | 📅 2026-09-04 - Auto Nix GC Roots Retention. This tool simply deletes auto GC roots based on the modified time of their symbolic link target.
...
* [Devbox](https://github.com/jetify-com/devbox) ⭐ 12,341 | 🐛 496 | 🌐 Go | 📅 2026-09-04 - Instant, portable, and predictable development environments.
* [flox](https://github.com/flox/flox) ⭐ 4,123 | 🐛 444 | 🌐 Rust | 📅 2026-09-06 - Manage and share development environments, package projects, and publish artifacts anywhere.
* [nix-direnv](https://github.com/nix-community/nix-direnv) ⭐ 2,769 | 🐛 7 | 🌐 Shell | 📅 2026-09-06 - A fast loader and flake-compliant configuration for the direnv environment auto-loader.
* [attic](https://github.com/zhaofengli/attic) ⭐ 2,054 | 🐛 167 | 🌐 Rust | 📅 2026-09-02 - Multi-tenant Nix Binary Cache.
...
* [flake-utils](https://github.com/numtide/flake-utils) ⭐ 1,626 | 🐛 23 | 🌐 Nix | 📅 2024-11-13 - Pure Nix flake utility functions to help with writing flakes.
* [devshell](https://github.com/numtide/devshell) ⭐ 1,552 | 🐛 97 | 🌐 Nix | 📅 2026-09-02 - `mkShell` with extra bits and a toml config option to be able to onboard non-nix users.
* [nixd](https://github.com/nix-community/nixd) ⭐ 1,481 | 🐛 105 | 🌐 C++ | 📅 2026-09-07 - Nix language server, based on Nix libraries.
...
* [Arion](https://github.com/hercules-ci/arion) ⭐ 916 | 🐛 99 | 🌐 Nix | 📅 2026-09-05 - Run `docker-compose` with help from Nix/NixOS.
* [nix2container](https://github.com/nlewo/nix2container) ⭐ 905 | 🐛 89 | 🌐 Go | 📅 2026-09-07 - An efficient container building workflow with Nix.
* [compose2nix](https://github.com/aksiksi/compose2nix) ⭐ 895 | 🐛 13 | 🌐 Go | 📅 2026-08-25 - Generate a NixOS config from a Docker Compose project.
* [lorri](https://github.com/nix-community/lorri/) ⭐ 874 | 🐛 24 | 🌐 Go | 📅 2026-04-29 - A much better `nix-shell` for development that augments direnv.
* [nix-update](https://github.com/Mic92/nix-update) ⭐ 873 | 🐛 53 | 🌐 Python | 📅 2026-09-06 - Update versions/source hashes of nix packages.
* [pre-commit-hooks.nix](https://github.com/cachix/git-hooks.nix) ⭐ 861 | 🐛 97 | 🌐 Nix | 📅 2026-09-07 - Run linters/formatters at commit time and on your CI.
* [MCP-NixOS](https://github.com/utensils/mcp-nixos) ⭐ 826 | 🐛 0 | 🌐 Python | 📅 2026-09-05 - An MCP server that provides AI assistants with accurate information about NixOS packages, options, Home Manager, and nix-darwin configurations.
* [robotnix](https://github.com/nix-community/robotnix) ⭐ 805 | 🐛 81 | 🌐 Nix | 📅 2026-09-06 - A declarative and reproducible build system for Android (AOSP) images.
* [services-flake](https://github.com/juspay/services-flake) ⭐ 766 | 🐛 59 | 🌐 Nix | 📅 2026-09-06 - A NixOS-like service configuration framework for Nix flakes.
* [rnix-lsp](https://github.com/nix-community/rnix-lsp) ⚠️ Archived - A syntax-checking language server for Nix.
* [treefmt-nix](https://github.com/numtide/treefmt-nix) ⭐ 646 | 🐛 94 | 🌐 Nix | 📅 2026-08-16 - A formatter that allows formatting all your project files with a single command, all via a single `.nix` file.
* [nixpkgs-review](https://github.com/Mic92/nixpkgs-review) ⭐ 637 | 🐛 71 | 🌐 Python | 📅 2026-09-05 - The best tool to verify that a pull-request in Nixpkgs is building properly.
...
* [npins](https://github.com/andir/npins) ⭐ 566 | 🐛 33 | 🌐 Rust | 📅 2026-09-02 - A simple tool for handling different types of dependencies in a Nix project. It is inspired by and comparable to Niv.
...
* [haumea](https://github.com/nix-community/haumea) ⭐ 419 | 🐛 14 | 🌐 Nix | 📅 2026-08-23 - Filesystem-based module system for the Nix language similar to traditional programming languages, with support for file hierarchy and visibility.
...
* [nix-oci](https://github.com/Dauliac/nix-oci) ⭐ 115 | 🐛 4 | 🌐 Nix | 📅 2026-09-07 - A flake-parts module for building minimal, reproducible OCI containers using nix2container.
...
* [nixidy](https://github.com/arnarg/nixidy) ⭐ 384 | 🐛 3 | 🌐 Nix | 📅 2026-09-07 - Kubernetes GitOps with Nix and Argo CD.
...
* [nix-gleam](https://github.com/arnarg/nix-gleam) ⭐ 70 | 🐛 4 | 🌐 Nix | 📅 2026-06-26 - Generic Nix builder for Gleam applications.

### Haskell

* [haskell.nix](https://github.com/input-output-hk/haskell.nix) ⭐ 632 | 🐛 105 | 🌐 Nix | 📅 2026-09-07 - Alternative Haskell Infrastructure for Nixpkgs.
...
* [nix-shell](https://github.com/loophp/nix-shell/) ⭐ 179 | 🐛 4 | 🌐 Nix | 📅 2026-09-07 - Nix shells for PHP development.
...
* [poetry2nix](https://github.com/nix-community/poetry2nix) ⭐ 929 | 🐛 188 | 🌐 Nix | 📅 2026-09-07 - Build Python packages directly from [Poetry's](https://python-poetry.org/) `poetry.lock`. No conversion step needed.
* [uv2nix](https://github.com/pyproject-nix/uv2nix) ⭐ 775 | 🐛 2 | 🌐 Nix | 📅 2026-09-07 - Convert [`uv` workspaces](https://docs.astral.sh/uv/concepts/projects/workspaces/) into pure Nix derivations.
...
* [crane](https://github.com/ipetkov/crane) ⭐ 1,457 | 🐛 40 | 🌐 Nix | 📅 2026-09-03 - A Nix library for building Cargo projects with incremental artifact caching.
* [fenix](https://github.com/nix-community/fenix) ⭐ 1,116 | 🐛 38 | 🌐 Nix | 📅 2026-09-07 - Rust toolchains and Rust analyzer nightly for nix.
...
* [nix-cargo-integration](https://github.com/90-008/nix-cargo-integration) ⭐ 217 | 🐛 5 | 🌐 Nix | 📅 2026-09-07 - A library that allows easy and effortless integration for Cargo projects.
...
* [zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 190 | 🐛 6 | 🌐 Zig | 📅 2026-09-07 - Flake for packaging, building and running Zig projects.
...
* [Home Manager](https://github.com/nix-community/home-manager) ⭐ 10,335 | 🐛 1,008 | 🌐 Nix | 📅 2026-09-07 - Manage your user configuration just like NixOS.
* [nix-darwin](https://github.com/nix-darwin/nix-darwin) ⭐ 5,909 | 🐛 475 | 🌐 Nix | 📅 2026-08-16 - Manage macOS configuration just like on NixOS.
* [NixOS hardware](https://github.com/NixOS/nixos-hardware) ⭐ 3,296 | 🐛 323 | 🌐 Nix | 📅 2026-09-03 - NixOS profiles to optimize settings for different hardware.
* [NixOS-WSL](https://github.com/nix-community/NixOS-WSL) ⭐ 3,084 | 🐛 54 | 🌐 Nix | 📅 2026-09-02 - Modules for running NixOS on the Windows Subsystem for Linux.
* [Nixvim](https://github.com/nix-community/nixvim) ⭐ 2,944 | 🐛 160 | 🌐 Nix | 📅 2026-09-07 - A pre-packaged Neovim distribution built with Nix modules and Nixpkgs.
* [Stylix](https://github.com/nix-community/stylix) ⭐ 2,395 | 🐛 284 | 🌐 Nix | 📅 2026-09-01 - System-wide colorscheming and typography for NixOS.
* [impermanence](https://github.com/nix-community/impermanence) ⭐ 1,884 | 🐛 106 | 🌐 Nix | 📅 2026-01-27 - Lets you choose what files and directories you want to keep between reboots.
* [nvf](https://github.com/NotAShelf/nvf) ⭐ 1,625 | 🐛 128 | 🌐 Nix | 📅 2026-09-04 - A portable, modular Neovim configuration framework for Nix.
* [nix-topology](https://github.com/oddlama/nix-topology) ⭐ 994 | 🐛 22 | 🌐 Nix | 📅 2026-06-22 - Generate infrastructure and network diagrams directly from your NixOS configuration.
* [musnix](https://github.com/musnix/musnix) ⭐ 944 | 🐛 14 | 🌐 Nix | 📅 2026-09-01 - Do real-time audio work in NixOS.
...
* [Self Host Blocks](https://github.com/ibizaman/selfhostblocks) ⭐ 495 | 🐛 120 | 🌐 Nix | 📅 2026-09-07 - Modular server management based on NixOS modules and focused on best practices.
* [base16.nix](https://github.com/SenchoPens/base16.nix) ⭐ 286 | 🐛 3 | 🌐 Nix | 📅 2025-08-21 - Flake way to theme programs in [base16](https://github.com/chriskempson/base16) ⭐ 962 | 🐛 1 | 📅 2023-10-12 colorschemes, mustache template support included.
...
* [Nix Software Center](https://github.com/snowfallorg/nix-software-center) ⭐ 847 | 🐛 59 | 🌐 Rust | 📅 2026-04-07 - Install and manage Nix packages. Desktop app in Rust and GTK.
...
* [NUR](https://github.com/nix-community/NUR/) ⭐ 1,946 | 🐛 38 | 🌐 Python | 📅 2026-09-07 - Nix User Repositories. The mother of all overlays, allowing access to user repositories and installing packages via attributes.
* [System Manager](https://github.com/numtide/system-manager) ⭐ 1,717 | 🐛 61 | 🌐 Nix | 📅 2026-09-07 - A non-NixOS Linux system configuration tool built on Nix.
* [rust-overlay](https://github.com/oxalica/rust-overlay) ⭐ 1,555 | 🐛 23 | 🌐 Nix | 📅 2026-09-07 - Pure and reproducible nix overlay of binary distributed Rust toolchains.
* [nixpkgs-wayland](https://github.com/nix-community/nixpkgs-wayland) ⭐ 629 | 🐛 55 | 🌐 Nix | 📅 2026-09-07 - Bleeding-edge Wayland packages.
* [nixpkgs-mozilla](https://github.com/mozilla/nixpkgs-mozilla) ⚠️ Archived - Mozilla's overlay with Rust toolchains and Firefox.
* [zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 543 | 🐛 10 | 🌐 Nix | 📅 2026-09-07 - A Nix flake packaging the Zig compiler. The flake mirrors the binaries built officially by Zig and does not build them from source.
* [neovim-nightly-overlay](https://github.com/nix-community/neovim-nightly-overlay) ⭐ 417 | 🐛 1 | 🌐 Nix | 📅 2026-09-07 - Daily bumped Neovim nightly package.
* [awesome-nix-hpc](https://github.com/freuk/awesome-nix-hpc) ⭐ 102 | 🐛 0 | 📅 2025-04-22 - High Performance Computing package sets.
* [nixpkgs-firefox-darwin](https://github.com/bandithedoge/nixpkgs-firefox-darwin) ⭐ 74 | 🐛 3 | 🌐 Nix | 📅 2026-09-07 - Automatically updated Firefox binary packages for macOS.

## Distributions

* [nixbsd](https://github.com/nixos-bsd/nixbsd) ⭐ 1,040 | 🐛 21 | 🌐 Nix | 📅 2026-07-10 - A NixOS fork with a FreeBSD kernel.
