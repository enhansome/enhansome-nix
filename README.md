...
[Nix](https://github.com/nixos/nix) ⭐ 17,592 | 🐛 2,939 | 🌐 C++ | 📅 2026-08-28 is a powerful package manager for Linux and other Unix systems that makes package management reliable and reproducible.
...
* [nix-installer](https://github.com/DeterminateSystems/nix-installer) ⭐ 3,679 | 🐛 437 | 🌐 Rust | 📅 2026-08-23 - Opinionated alternative to the official Nix install scripts.
* [nixos-anywhere](https://github.com/nix-community/nixos-anywhere) ⭐ 3,412 | 🐛 104 | 🌐 Shell | 📅 2026-08-26 - Install NixOS everywhere via SSH.
...
* [deploy-rs](https://github.com/serokell/deploy-rs) ⭐ 2,289 | 🐛 143 | 🌐 Rust | 📅 2026-08-24 - A simple multi-profile Nix-flake deploy tool.
...
* [microvm](https://github.com/microvm-nix/microvm.nix) ⭐ 2,893 | 🐛 57 | 🌐 Nix | 📅 2026-08-27 - NixOS-based MicroVMs.
...
* [agent-sandbox.nix](https://github.com/archie-judd/agent-sandbox.nix) ⭐ 146 | 🐛 12 | 🌐 Shell | 📅 2026-08-28 - Declarative sandboxing for any package (e.g. AI coding agents) using bubblewrap on Linux and sandbox-exec on macOS.

## Command-Line Tools

* [devenv](https://github.com/cachix/devenv) ⭐ 7,450 | 🐛 360 | 🌐 Rust | 📅 2026-08-28 - A Nix-based tool for creating developer shell environments quickly and reproducibly.
* [nh](https://github.com/nix-community/nh) ⭐ 3,156 | 🐛 82 | 🌐 Rust | 📅 2026-08-29 - Better output for `nix`, `nixos-rebuild`, `home-manager` and nix-darwin CLI leveraging `dix` and `nix-output-monitor`.
* [comma](https://github.com/nix-community/comma) ⭐ 1,751 | 🐛 13 | 🌐 Rust | 📅 2026-06-26 - Quickly run any binary; wraps together `nix run` and `nix-index`.
* [nix-output-monitor](https://github.com/maralorn/nix-output-monitor) ⭐ 1,648 | 🐛 104 | 🌐 Haskell | 📅 2026-08-28 - A tool to produce useful graphs and statistics when building derivations.
...
* [nix-init](https://github.com/nix-community/nix-init) ⭐ 1,460 | 🐛 27 | 🌐 Rust | 📅 2026-08-29 - Generate Nix packages from URLs with hash prefetching, dependency inference, license detection, and more.
...
* [nurl](https://github.com/nix-community/nurl) ⭐ 779 | 🐛 16 | 🌐 Rust | 📅 2026-08-28 - Generate Nix fetcher calls from repository URLs.
...
* [Devbox](https://github.com/jetify-com/devbox) ⭐ 12,318 | 🐛 497 | 🌐 Go | 📅 2026-08-18 - Instant, portable, and predictable development environments.
* [flox](https://github.com/flox/flox) ⭐ 4,108 | 🐛 440 | 🌐 Rust | 📅 2026-08-29 - Manage and share development environments, package projects, and publish artifacts anywhere.
* [nix-direnv](https://github.com/nix-community/nix-direnv) ⭐ 2,766 | 🐛 9 | 🌐 Shell | 📅 2026-08-26 - A fast loader and flake-compliant configuration for the direnv environment auto-loader.
* [attic](https://github.com/zhaofengli/attic) ⭐ 2,039 | 🐛 164 | 🌐 Rust | 📅 2026-08-22 - Multi-tenant Nix Binary Cache.
* [nil](https://github.com/oxalica/nil) ⭐ 1,902 | 🐛 34 | 🌐 Rust | 📅 2026-07-26 - NIx Language server, an incremental analysis assistent for writing in Nix.
...
* [nixd](https://github.com/nix-community/nixd) ⭐ 1,469 | 🐛 106 | 🌐 C++ | 📅 2026-08-24 - Nix language server, based on Nix libraries.
...
* [robotnix](https://github.com/nix-community/robotnix) ⭐ 802 | 🐛 82 | 🌐 Nix | 📅 2026-08-23 - A declarative and reproducible build system for Android (AOSP) images.
...
* [nixpkgs-review](https://github.com/Mic92/nixpkgs-review) ⭐ 637 | 🐛 84 | 🌐 Python | 📅 2026-08-29 - The best tool to verify that a pull-request in Nixpkgs is building properly.
...
* [crane](https://github.com/ipetkov/crane) ⭐ 1,452 | 🐛 40 | 🌐 Nix | 📅 2026-08-21 - A Nix library for building Cargo projects with incremental artifact caching.
* [fenix](https://github.com/nix-community/fenix) ⭐ 1,113 | 🐛 38 | 🌐 Nix | 📅 2026-08-29 - Rust toolchains and Rust analyzer nightly for nix.
...
* [nix-cargo-integration](https://github.com/90-008/nix-cargo-integration) ⭐ 217 | 🐛 5 | 🌐 Nix | 📅 2026-08-29 - A library that allows easy and effortless integration for Cargo projects.
...
* [zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 188 | 🐛 6 | 🌐 Zig | 📅 2026-08-29 - Flake for packaging, building and running Zig projects.
...
* [Home Manager](https://github.com/nix-community/home-manager) ⭐ 10,297 | 🐛 1,001 | 🌐 Nix | 📅 2026-08-29 - Manage your user configuration just like NixOS.
* [nix-darwin](https://github.com/nix-darwin/nix-darwin) ⭐ 5,886 | 🐛 473 | 🌐 Nix | 📅 2026-08-16 - Manage macOS configuration just like on NixOS.
...
* [Nixvim](https://github.com/nix-community/nixvim) ⭐ 2,935 | 🐛 156 | 🌐 Nix | 📅 2026-08-29 - A pre-packaged Neovim distribution built with Nix modules and Nixpkgs.
* [Stylix](https://github.com/nix-community/stylix) ⭐ 2,388 | 🐛 277 | 🌐 Nix | 📅 2026-08-26 - System-wide colorscheming and typography for NixOS.
...
* [nvf](https://github.com/NotAShelf/nvf) ⭐ 1,618 | 🐛 125 | 🌐 Nix | 📅 2026-08-27 - A portable, modular Neovim configuration framework for Nix.
...
* [nix-mineral](https://github.com/cynicsketch/nix-mineral) ⭐ 553 | 🐛 40 | 🌐 Nix | 📅 2026-08-28 - Conveniently and reasonably harden NixOS.
* [Self Host Blocks](https://github.com/ibizaman/selfhostblocks) ⭐ 493 | 🐛 122 | 🌐 Nix | 📅 2026-08-29 - Modular server management based on NixOS modules and focused on best practices.
...
* [Nix Software Center](https://github.com/snowfallorg/nix-software-center) ⭐ 845 | 🐛 59 | 🌐 Rust | 📅 2026-04-07 - Install and manage Nix packages. Desktop app in Rust and GTK.
...
* [NUR](https://github.com/nix-community/NUR/) ⭐ 1,940 | 🐛 38 | 🌐 Python | 📅 2026-08-29 - Nix User Repositories. The mother of all overlays, allowing access to user repositories and installing packages via attributes.
...
* [rust-overlay](https://github.com/oxalica/rust-overlay) ⭐ 1,552 | 🐛 23 | 🌐 Nix | 📅 2026-08-29 - Pure and reproducible nix overlay of binary distributed Rust toolchains.
...
* [zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 542 | 🐛 10 | 🌐 Nix | 📅 2026-08-29 - A Nix flake packaging the Zig compiler. The flake mirrors the binaries built officially by Zig and does not build them from source.
...
* [nixpkgs-firefox-darwin](https://github.com/bandithedoge/nixpkgs-firefox-darwin) ⭐ 74 | 🐛 3 | 🌐 Nix | 📅 2026-08-29 - Automatically updated Firefox binary packages for macOS.

## Distributions

* [nixbsd](https://github.com/nixos-bsd/nixbsd) ⭐ 1,032 | 🐛 21 | 🌐 Nix | 📅 2026-07-10 - A NixOS fork with a FreeBSD kernel.
