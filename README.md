...
[Nix](https://github.com/nixos/nix) ⭐ 17,708 | 🐛 2,954 | 🌐 C++ | 📅 2026-09-14 is a powerful package manager for Linux and other Unix systems that makes package management reliable and reproducible.
...
* [Nix Starter Config](https://github.com/Misterio77/nix-starter-configs) ⭐ 3,834 | 🐛 16 | 🌐 Nix | 📅 2026-04-24 - A few simple Nix Flake templates for getting started with NixOS + home-manager.
* [NixOS & Flakes Book](https://github.com/ryan4yin/nixos-and-flakes-book) ⭐ 3,287 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-05 - An unofficial and opinionated NixOS & Flakes book for beginners.
...
* [NüschtOS Search](https://github.com/NuschtOS/search) ⭐ 168 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-14 - Simple and fast static-page NixOS option search.
...
* [nix-installer](https://github.com/DeterminateSystems/nix-installer) ⭐ 3,686 | 🐛 439 | 🌐 Rust | 📅 2026-09-13 - Opinionated alternative to the official Nix install scripts.
* [nixos-anywhere](https://github.com/nix-community/nixos-anywhere) ⭐ 3,442 | 🐛 104 | 🌐 Shell | 📅 2026-09-09 - Install NixOS everywhere via SSH.
...
* [Colmena](https://github.com/nix-community/colmena) ⭐ 2,343 | 🐛 147 | 🌐 Rust | 📅 2026-09-10 - A simple, stateless NixOS deployment tool modeled after NixOps and morph.
* [deploy-rs](https://github.com/serokell/deploy-rs) ⭐ 2,319 | 🐛 131 | 🌐 Rust | 📅 2026-09-14 - A simple multi-profile Nix-flake deploy tool.
* [NixOps](https://github.com/NixOS/nixops) ⭐ 2,199 | 🐛 327 | 🌐 Python | 📅 2025-12-28 - The official Nix deployment tool, compatible with AWS, Hetzner, and more.
...
* [comin](https://github.com/nlewo/comin) ⭐ 1,013 | 🐛 49 | 🌐 Go | 📅 2026-08-28 - A deployment tool to continuously pull from Git repositories.
* [KuberNix](https://github.com/saschagrunert/kubernix) ⭐ 824 | 🐛 0 | 🌐 Rust | 📅 2026-09-14 - Single-dependency Kubernetes clusters via Nix packages.
...
* [microvm](https://github.com/microvm-nix/microvm.nix) ⭐ 2,931 | 🐛 57 | 🌐 Nix | 📅 2026-09-14 - NixOS-based MicroVMs.
...
* [devenv](https://github.com/cachix/devenv) ⭐ 7,645 | 🐛 371 | 🌐 Rust | 📅 2026-09-13 - A Nix-based tool for creating developer shell environments quickly and reproducibly.
* [nh](https://github.com/nix-community/nh) ⭐ 3,198 | 🐛 85 | 🌐 Rust | 📅 2026-09-13 - Better output for `nix`, `nixos-rebuild`, `home-manager` and nix-darwin CLI leveraging `dix` and `nix-output-monitor`.
...
* [nix-output-monitor](https://github.com/maralorn/nix-output-monitor) ⭐ 1,657 | 🐛 112 | 🌐 Haskell | 📅 2026-08-28 - A tool to produce useful graphs and statistics when building derivations.
* [nixfmt](https://github.com/NixOS/nixfmt) ⭐ 1,606 | 🐛 20 | 🌐 Haskell | 📅 2026-09-11 - A formatter for Nix code, intended to easily apply a uniform style.
* [nix-init](https://github.com/nix-community/nix-init) ⭐ 1,464 | 🐛 30 | 🌐 Rust | 📅 2026-09-14 - Generate Nix packages from URLs with hash prefetching, dependency inference, license detection, and more.
* [alejandra](https://github.com/kamadorueda/alejandra) ⭐ 1,401 | 🐛 64 | 🌐 Nix | 📅 2026-09-11 - An opinionated Nix code formatter optimized for speed and consistency.
...
* [nix-tree](https://github.com/utdemir/nix-tree) ⭐ 1,076 | 🐛 20 | 🌐 Haskell | 📅 2026-09-01 - Interactively browse the dependency graph of Nix derivations.
...
* [nix-alien](https://github.com/thiagokokada/nix-alien) ⭐ 875 | 🐛 1 | 🌐 Python | 📅 2026-07-15 - Run unpatched binaries on Nix/NixOS easily.
* [nurl](https://github.com/nix-community/nurl) ⭐ 785 | 🐛 17 | 🌐 Rust | 📅 2026-09-14 - Generate Nix fetcher calls from repository URLs.
...
* [dix](https://github.com/manic-systems/dix) ⭐ 349 | 🐛 7 | 🌐 Rust | 📅 2026-09-14 - Diff Nix; a super-fast tool to diff Nix related things.
...
* [angrr](https://github.com/linyinfeng/angrr) ⭐ 145 | 🐛 8 | 🌐 Rust | 📅 2026-09-11 - Auto Nix GC Roots Retention. This tool simply deletes auto GC roots based on the modified time of their symbolic link target.
...
* [Devbox](https://github.com/jetify-com/devbox) ⭐ 12,357 | 🐛 466 | 🌐 Go | 📅 2026-09-14 - Instant, portable, and predictable development environments.
* [flox](https://github.com/flox/flox) ⭐ 4,124 | 🐛 446 | 🌐 Rust | 📅 2026-09-14 - Manage and share development environments, package projects, and publish artifacts anywhere.
* [nix-direnv](https://github.com/nix-community/nix-direnv) ⭐ 2,774 | 🐛 8 | 🌐 Shell | 📅 2026-09-13 - A fast loader and flake-compliant configuration for the direnv environment auto-loader.
...
* [nixd](https://github.com/nix-community/nixd) ⭐ 1,480 | 🐛 105 | 🌐 C++ | 📅 2026-09-14 - Nix language server, based on Nix libraries.
...
* [Arion](https://github.com/hercules-ci/arion) ⭐ 918 | 🐛 99 | 🌐 Nix | 📅 2026-09-05 - Run `docker-compose` with help from Nix/NixOS.
* [nix2container](https://github.com/nlewo/nix2container) ⭐ 911 | 🐛 96 | 🌐 Go | 📅 2026-09-07 - An efficient container building workflow with Nix.
...
* [pre-commit-hooks.nix](https://github.com/cachix/git-hooks.nix) ⭐ 864 | 🐛 99 | 🌐 Nix | 📅 2026-09-07 - Run linters/formatters at commit time and on your CI.
...
* [robotnix](https://github.com/nix-community/robotnix) ⭐ 808 | 🐛 80 | 🌐 Nix | 📅 2026-09-13 - A declarative and reproducible build system for Android (AOSP) images.
...
* [treefmt-nix](https://github.com/numtide/treefmt-nix) ⭐ 649 | 🐛 97 | 🌐 Nix | 📅 2026-08-16 - A formatter that allows formatting all your project files with a single command, all via a single `.nix` file.
...
* [flakelight](https://github.com/nix-community/flakelight) ⭐ 411 | 🐛 4 | 🌐 Nix | 📅 2026-09-14 - A modular flake framework aiming to minimize boilerplate.
...
* [flake-edit](https://github.com/a-kenji/flake-edit) ⭐ 89 | 🐛 9 | 🌐 Rust | 📅 2026-09-14 - Edit your flake inputs with auto-follows and update functionality directly from the CLI.
...
* [clj-nix](https://github.com/jlesquembre/clj-nix) ⭐ 184 | 🐛 33 | 🌐 Clojure | 📅 2026-09-14 - Nix helper functions for Clojure projects.
...
* [haskell.nix](https://github.com/input-output-hk/haskell.nix) ⭐ 632 | 🐛 105 | 🌐 Nix | 📅 2026-09-14 - Alternative Haskell Infrastructure for Nixpkgs.
...
* [lean4-nix](https://github.com/lenianiva/lean4-nix) ⭐ 124 | 🐛 10 | 🌐 Nix | 📅 2026-08-27 -  Nix flake build for Lean 4, and `lake2nix`.
...
* [poetry2nix](https://github.com/nix-community/poetry2nix) ⭐ 929 | 🐛 188 | 🌐 Nix | 📅 2026-09-14 - Build Python packages directly from [Poetry's](https://python-poetry.org/) `poetry.lock`. No conversion step needed.
* [uv2nix](https://github.com/pyproject-nix/uv2nix) ⭐ 779 | 🐛 2 | 🌐 Nix | 📅 2026-09-14 - Convert [`uv` workspaces](https://docs.astral.sh/uv/concepts/projects/workspaces/) into pure Nix derivations.
...
* [crane](https://github.com/ipetkov/crane) ⭐ 1,462 | 🐛 40 | 🌐 Nix | 📅 2026-09-03 - A Nix library for building Cargo projects with incremental artifact caching.
* [fenix](https://github.com/nix-community/fenix) ⭐ 1,117 | 🐛 40 | 🌐 Nix | 📅 2026-09-14 - Rust toolchains and Rust analyzer nightly for nix.
...
* [nix-cargo-integration](https://github.com/90-008/nix-cargo-integration) ⭐ 217 | 🐛 5 | 🌐 Nix | 📅 2026-09-14 - A library that allows easy and effortless integration for Cargo projects.
...
* [zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 191 | 🐛 7 | 🌐 Zig | 📅 2026-09-14 - Flake for packaging, building and running Zig projects.
...
* [Home Manager](https://github.com/nix-community/home-manager) ⭐ 10,346 | 🐛 990 | 🌐 Nix | 📅 2026-09-14 - Manage your user configuration just like NixOS.
* [nix-darwin](https://github.com/nix-darwin/nix-darwin) ⭐ 5,924 | 🐛 478 | 🌐 Nix | 📅 2026-08-16 - Manage macOS configuration just like on NixOS.
* [NixOS hardware](https://github.com/NixOS/nixos-hardware) ⭐ 3,298 | 🐛 324 | 🌐 Nix | 📅 2026-09-11 - NixOS profiles to optimize settings for different hardware.
* [NixOS-WSL](https://github.com/nix-community/NixOS-WSL) ⭐ 3,093 | 🐛 46 | 🌐 Nix | 📅 2026-09-14 - Modules for running NixOS on the Windows Subsystem for Linux.
* [Nixvim](https://github.com/nix-community/nixvim) ⭐ 2,946 | 🐛 160 | 🌐 Nix | 📅 2026-09-14 - A pre-packaged Neovim distribution built with Nix modules and Nixpkgs.
* [Stylix](https://github.com/nix-community/stylix) ⭐ 2,404 | 🐛 286 | 🌐 Nix | 📅 2026-09-01 - System-wide colorscheming and typography for NixOS.
...
* [nvf](https://github.com/NotAShelf/nvf) ⭐ 1,628 | 🐛 130 | 🌐 Nix | 📅 2026-09-13 - A portable, modular Neovim configuration framework for Nix.
* [nix-topology](https://github.com/oddlama/nix-topology) ⭐ 1,002 | 🐛 23 | 🌐 Nix | 📅 2026-06-22 - Generate infrastructure and network diagrams directly from your NixOS configuration.
...
* [nix-mineral](https://github.com/cynicsketch/nix-mineral) ⭐ 558 | 🐛 39 | 🌐 Nix | 📅 2026-09-14 - Conveniently and reasonably harden NixOS.
* [Self Host Blocks](https://github.com/ibizaman/selfhostblocks) ⭐ 496 | 🐛 118 | 🌐 Nix | 📅 2026-09-14 - Modular server management based on NixOS modules and focused on best practices.
* [base16.nix](https://github.com/SenchoPens/base16.nix) ⭐ 286 | 🐛 3 | 🌐 Nix | 📅 2025-08-21 - Flake way to theme programs in [base16](https://github.com/chriskempson/base16) ⭐ 966 | 🐛 2 | 📅 2023-10-12 colorschemes, mustache template support included.
...
* [NUR](https://github.com/nix-community/NUR/) ⭐ 1,948 | 🐛 40 | 🌐 Python | 📅 2026-09-14 - Nix User Repositories. The mother of all overlays, allowing access to user repositories and installing packages via attributes.
* [System Manager](https://github.com/numtide/system-manager) ⭐ 1,723 | 🐛 65 | 🌐 Nix | 📅 2026-09-14 - A non-NixOS Linux system configuration tool built on Nix.
* [rust-overlay](https://github.com/oxalica/rust-overlay) ⭐ 1,557 | 🐛 23 | 🌐 Nix | 📅 2026-09-14 - Pure and reproducible nix overlay of binary distributed Rust toolchains.
...
* [zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 545 | 🐛 10 | 🌐 Nix | 📅 2026-09-14 - A Nix flake packaging the Zig compiler. The flake mirrors the binaries built officially by Zig and does not build them from source.
* [neovim-nightly-overlay](https://github.com/nix-community/neovim-nightly-overlay) ⭐ 418 | 🐛 1 | 🌐 Nix | 📅 2026-09-14 - Daily bumped Neovim nightly package.
* [awesome-nix-hpc](https://github.com/freuk/awesome-nix-hpc) ⭐ 102 | 🐛 0 | 📅 2025-04-22 - High Performance Computing package sets.
* [nixpkgs-firefox-darwin](https://github.com/bandithedoge/nixpkgs-firefox-darwin) ⭐ 74 | 🐛 3 | 🌐 Nix | 📅 2026-09-14 - Automatically updated Firefox binary packages for macOS.
