...
[Nix](https://github.com/nixos/nix) ⭐ 17,775 | 🐛 2,977 | 🌐 C++ | 📅 2026-09-24 is a powerful package manager for Linux and other Unix systems that makes package management reliable and reproducible.
...
* [Nix Starter Config](https://github.com/Misterio77/nix-starter-configs) ⭐ 3,838 | 🐛 16 | 🌐 Nix | 📅 2026-04-24 - A few simple Nix Flake templates for getting started with NixOS + home-manager.
...
* [nix-installer](https://github.com/DeterminateSystems/nix-installer) ⭐ 3,699 | 🐛 439 | 🌐 Rust | 📅 2026-09-24 - Opinionated alternative to the official Nix install scripts.
...
* [Colmena](https://github.com/nix-community/colmena) ⭐ 2,355 | 🐛 143 | 🌐 Rust | 📅 2026-09-23 - A simple, stateless NixOS deployment tool modeled after NixOps and morph.
* [deploy-rs](https://github.com/serokell/deploy-rs) ⭐ 2,334 | 🐛 131 | 🌐 Rust | 📅 2026-09-21 - A simple multi-profile Nix-flake deploy tool.
...
* [comin](https://github.com/nlewo/comin) ⭐ 1,031 | 🐛 45 | 🌐 Go | 📅 2026-09-16 - A deployment tool to continuously pull from Git repositories.
...
* [microvm](https://github.com/microvm-nix/microvm.nix) ⭐ 2,964 | 🐛 59 | 🌐 Nix | 📅 2026-09-23 - NixOS-based MicroVMs.
...
* [devenv](https://github.com/cachix/devenv) ⭐ 7,676 | 🐛 371 | 🌐 Rust | 📅 2026-09-24 - A Nix-based tool for creating developer shell environments quickly and reproducibly.
* [nh](https://github.com/nix-community/nh) ⭐ 3,225 | 🐛 86 | 🌐 Rust | 📅 2026-09-24 - Better output for `nix`, `nixos-rebuild`, `home-manager` and nix-darwin CLI leveraging `dix` and `nix-output-monitor`.
* [comma](https://github.com/nix-community/comma) ⭐ 1,770 | 🐛 12 | 🌐 Rust | 📅 2026-09-01 - Quickly run any binary; wraps together `nix run` and `nix-index`.
...
* [nixfmt](https://github.com/NixOS/nixfmt) ⭐ 1,613 | 🐛 22 | 🌐 Haskell | 📅 2026-09-22 - A formatter for Nix code, intended to easily apply a uniform style.
...
* [alejandra](https://github.com/kamadorueda/alejandra) ⭐ 1,406 | 🐛 64 | 🌐 Nix | 📅 2026-09-11 - An opinionated Nix code formatter optimized for speed and consistency.
...
* [statix](https://github.com/oppiliappan/statix) ⭐ 948 | 🐛 46 | 🌐 Rust | 📅 2026-07-26 - A linter/fixer to check for and fix antipatterns in Nix code.
...
* [nix-diff](https://github.com/Gabriella439/nix-diff) ⭐ 496 | 🐛 15 | 🌐 Haskell | 📅 2026-06-10 - A tool to explain why two Nix derivations differ.
...
* [Devbox](https://github.com/jetify-com/devbox) ⭐ 12,372 | 🐛 415 | 🌐 Go | 📅 2026-09-23 - Instant, portable, and predictable development environments.
* [flox](https://github.com/flox/flox) ⭐ 4,141 | 🐛 441 | 🌐 Rust | 📅 2026-09-24 - Manage and share development environments, package projects, and publish artifacts anywhere.
...
* [attic](https://github.com/zhaofengli/attic) ⭐ 2,082 | 🐛 175 | 🌐 Rust | 📅 2026-09-16 - Multi-tenant Nix Binary Cache.
* [nil](https://github.com/oxalica/nil) ⭐ 1,912 | 🐛 35 | 🌐 Rust | 📅 2026-07-26 - NIx Language server, an incremental analysis assistent for writing in Nix.
...
* [nixd](https://github.com/nix-community/nixd) ⭐ 1,493 | 🐛 104 | 🌐 C++ | 📅 2026-09-21 - Nix language server, based on Nix libraries.
* [flake.parts](https://github.com/hercules-ci/flake-parts) ⭐ 1,476 | 🐛 76 | 🌐 Nix | 📅 2026-09-03 - Minimal Nix modules framework for Flakes: split your flakes into modules and get things done with community modules.
...
* [nix2container](https://github.com/nlewo/nix2container) ⭐ 915 | 🐛 92 | 🌐 Go | 📅 2026-09-24 - An efficient container building workflow with Nix.
...
* [nix-update](https://github.com/Mic92/nix-update) ⭐ 880 | 🐛 53 | 🌐 Python | 📅 2026-09-20 - Update versions/source hashes of nix packages.
...
* [pre-commit-hooks.nix](https://github.com/cachix/git-hooks.nix) ⭐ 867 | 🐛 102 | 🌐 Nix | 📅 2026-09-22 - Run linters/formatters at commit time and on your CI.
* [MCP-NixOS](https://github.com/utensils/mcp-nixos) ⭐ 840 | 🐛 0 | 🌐 Python | 📅 2026-09-05 - An MCP server that provides AI assistants with accurate information about NixOS packages, options, Home Manager, and nix-darwin configurations.
...
* [services-flake](https://github.com/juspay/services-flake) ⭐ 769 | 🐛 56 | 🌐 Nix | 📅 2026-09-24 - A NixOS-like service configuration framework for Nix flakes.
* [rnix-lsp](https://github.com/nix-community/rnix-lsp) ⚠️ Archived - A syntax-checking language server for Nix.
* [treefmt-nix](https://github.com/numtide/treefmt-nix) ⭐ 652 | 🐛 102 | 🌐 Nix | 📅 2026-08-16 - A formatter that allows formatting all your project files with a single command, all via a single `.nix` file.
...
* [npins](https://github.com/andir/npins) ⭐ 573 | 🐛 31 | 🌐 Rust | 📅 2026-09-02 - A simple tool for handling different types of dependencies in a Nix project. It is inspired by and comparable to Niv.
...
* [haskell.nix](https://github.com/input-output-hk/haskell.nix) ⭐ 631 | 🐛 107 | 🌐 Nix | 📅 2026-09-24 - Alternative Haskell Infrastructure for Nixpkgs.
...
* [poetry2nix](https://github.com/nix-community/poetry2nix) ⭐ 927 | 🐛 188 | 🌐 Nix | 📅 2026-09-24 - Build Python packages directly from [Poetry's](https://python-poetry.org/) `poetry.lock`. No conversion step needed.
...
* [crane](https://github.com/ipetkov/crane) ⭐ 1,465 | 🐛 40 | 🌐 Nix | 📅 2026-09-18 - A Nix library for building Cargo projects with incremental artifact caching.
* [fenix](https://github.com/nix-community/fenix) ⭐ 1,121 | 🐛 38 | 🌐 Nix | 📅 2026-09-24 - Rust toolchains and Rust analyzer nightly for nix.
...
* [nix-cargo-integration](https://github.com/90-008/nix-cargo-integration) ⭐ 217 | 🐛 5 | 🌐 Nix | 📅 2026-09-24 - A library that allows easy and effortless integration for Cargo projects.
...
* [zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 191 | 🐛 7 | 🌐 Zig | 📅 2026-09-24 - Flake for packaging, building and running Zig projects.
...
* [Home Manager](https://github.com/nix-community/home-manager) ⭐ 10,382 | 🐛 977 | 🌐 Nix | 📅 2026-09-24 - Manage your user configuration just like NixOS.
* [nix-darwin](https://github.com/nix-darwin/nix-darwin) ⭐ 5,950 | 🐛 479 | 🌐 Nix | 📅 2026-08-16 - Manage macOS configuration just like on NixOS.
* [NixOS hardware](https://github.com/NixOS/nixos-hardware) ⭐ 3,309 | 🐛 327 | 🌐 Nix | 📅 2026-09-24 - NixOS profiles to optimize settings for different hardware.
* [NixOS-WSL](https://github.com/nix-community/NixOS-WSL) ⭐ 3,099 | 🐛 50 | 🌐 Nix | 📅 2026-09-22 - Modules for running NixOS on the Windows Subsystem for Linux.
* [Nixvim](https://github.com/nix-community/nixvim) ⭐ 2,952 | 🐛 160 | 🌐 Nix | 📅 2026-09-24 - A pre-packaged Neovim distribution built with Nix modules and Nixpkgs.
...
* [nvf](https://github.com/NotAShelf/nvf) ⭐ 1,637 | 🐛 129 | 🌐 Nix | 📅 2026-09-24 - A portable, modular Neovim configuration framework for Nix.
...
* [Self Host Blocks](https://github.com/ibizaman/selfhostblocks) ⭐ 501 | 🐛 119 | 🌐 Nix | 📅 2026-09-24 - Modular server management based on NixOS modules and focused on best practices.
...
* [NUR](https://github.com/nix-community/NUR/) ⭐ 1,955 | 🐛 41 | 🌐 Python | 📅 2026-09-24 - Nix User Repositories. The mother of all overlays, allowing access to user repositories and installing packages via attributes.
* [System Manager](https://github.com/numtide/system-manager) ⭐ 1,740 | 🐛 61 | 🌐 Nix | 📅 2026-09-24 - A non-NixOS Linux system configuration tool built on Nix.
* [rust-overlay](https://github.com/oxalica/rust-overlay) ⭐ 1,565 | 🐛 23 | 🌐 Nix | 📅 2026-09-24 - Pure and reproducible nix overlay of binary distributed Rust toolchains.
* [nixpkgs-wayland](https://github.com/nix-community/nixpkgs-wayland) ⭐ 628 | 🐛 56 | 🌐 Nix | 📅 2026-09-24 - Bleeding-edge Wayland packages.
* [nixpkgs-mozilla](https://github.com/mozilla/nixpkgs-mozilla) ⚠️ Archived - Mozilla's overlay with Rust toolchains and Firefox.
* [zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 549 | 🐛 10 | 🌐 Nix | 📅 2026-09-24 - A Nix flake packaging the Zig compiler. The flake mirrors the binaries built officially by Zig and does not build them from source.
* [neovim-nightly-overlay](https://github.com/nix-community/neovim-nightly-overlay) ⭐ 418 | 🐛 2 | 🌐 Nix | 📅 2026-09-24 - Daily bumped Neovim nightly package.
* [awesome-nix-hpc](https://github.com/freuk/awesome-nix-hpc) ⭐ 102 | 🐛 0 | 📅 2025-04-22 - High Performance Computing package sets.
* [nixpkgs-firefox-darwin](https://github.com/bandithedoge/nixpkgs-firefox-darwin) ⭐ 74 | 🐛 3 | 🌐 Nix | 📅 2026-09-24 - Automatically updated Firefox binary packages for macOS.

## Distributions

* [nixbsd](https://github.com/nixos-bsd/nixbsd) ⭐ 1,051 | 🐛 21 | 🌐 Nix | 📅 2026-09-11 - A NixOS fork with a FreeBSD kernel.
