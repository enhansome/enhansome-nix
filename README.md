...
[Nix](https://github.com/nixos/nix) ⭐ 17,682 | 🐛 2,953 | 🌐 C++ | 📅 2026-09-12 is a powerful package manager for Linux and other Unix systems that makes package management reliable and reproducible.
...
* [nix-installer](https://github.com/DeterminateSystems/nix-installer) ⭐ 3,685 | 🐛 439 | 🌐 Rust | 📅 2026-09-06 - Opinionated alternative to the official Nix install scripts.
* [nixos-anywhere](https://github.com/nix-community/nixos-anywhere) ⭐ 3,438 | 🐛 104 | 🌐 Shell | 📅 2026-09-09 - Install NixOS everywhere via SSH.
...
* [Colmena](https://github.com/nix-community/colmena) ⭐ 2,341 | 🐛 147 | 🌐 Rust | 📅 2026-09-10 - A simple, stateless NixOS deployment tool modeled after NixOps and morph.
* [deploy-rs](https://github.com/serokell/deploy-rs) ⭐ 2,313 | 🐛 133 | 🌐 Rust | 📅 2026-09-10 - A simple multi-profile Nix-flake deploy tool.
...
* [comin](https://github.com/nlewo/comin) ⭐ 1,009 | 🐛 47 | 🌐 Go | 📅 2026-08-28 - A deployment tool to continuously pull from Git repositories.
...
* [KubeNix](https://github.com/hall/kubenix) ⭐ 519 | 🐛 28 | 🌐 Nix | 📅 2026-09-06 - A Kubernetes resource builder using Nix.
...
* [microvm](https://github.com/microvm-nix/microvm.nix) ⭐ 2,921 | 🐛 60 | 🌐 Nix | 📅 2026-09-11 - NixOS-based MicroVMs.
...
* [agent-sandbox.nix](https://github.com/archie-judd/agent-sandbox.nix) ⭐ 156 | 🐛 8 | 🌐 Shell | 📅 2026-09-12 - Declarative sandboxing for any package (e.g. AI coding agents) using bubblewrap on Linux and sandbox-exec on macOS.

## Command-Line Tools

* [devenv](https://github.com/cachix/devenv) ⭐ 7,637 | 🐛 368 | 🌐 Rust | 📅 2026-09-11 - A Nix-based tool for creating developer shell environments quickly and reproducibly.
* [nh](https://github.com/nix-community/nh) ⭐ 3,193 | 🐛 84 | 🌐 Rust | 📅 2026-09-09 - Better output for `nix`, `nixos-rebuild`, `home-manager` and nix-darwin CLI leveraging `dix` and `nix-output-monitor`.
...
* [nix-output-monitor](https://github.com/maralorn/nix-output-monitor) ⭐ 1,655 | 🐛 112 | 🌐 Haskell | 📅 2026-08-28 - A tool to produce useful graphs and statistics when building derivations.
...
* [alejandra](https://github.com/kamadorueda/alejandra) ⭐ 1,400 | 🐛 64 | 🌐 Nix | 📅 2026-09-11 - An opinionated Nix code formatter optimized for speed and consistency.
...
* [nix-tree](https://github.com/utdemir/nix-tree) ⭐ 1,074 | 🐛 20 | 🌐 Haskell | 📅 2026-09-01 - Interactively browse the dependency graph of Nix derivations.
...
* [dix](https://github.com/manic-systems/dix) ⭐ 347 | 🐛 8 | 🌐 Rust | 📅 2026-09-12 - Diff Nix; a super-fast tool to diff Nix related things.
...
* [Devbox](https://github.com/jetify-com/devbox) ⭐ 12,353 | 🐛 496 | 🌐 Go | 📅 2026-09-12 - Instant, portable, and predictable development environments.
...
* [nix-update](https://github.com/Mic92/nix-update) ⭐ 875 | 🐛 52 | 🌐 Python | 📅 2026-09-06 - Update versions/source hashes of nix packages.
...
* [flake-edit](https://github.com/a-kenji/flake-edit) ⭐ 86 | 🐛 11 | 🌐 Rust | 📅 2026-09-07 - Edit your flake inputs with auto-follows and update functionality directly from the CLI.
...
* [haskell.nix](https://github.com/input-output-hk/haskell.nix) ⭐ 632 | 🐛 105 | 🌐 Nix | 📅 2026-09-12 - Alternative Haskell Infrastructure for Nixpkgs.
* [cabal2nix](https://github.com/NixOS/cabal2nix) ⭐ 402 | 🐛 98 | 🌐 Haskell | 📅 2026-08-21 - Converts a Cabal file into a Nix build expression.
* [haskell-flake](https://github.com/srid/haskell-flake) ⭐ 240 | 🐛 42 | 🌐 Nix | 📅 2026-09-06 - A `flake-parts` Nix module for Haskell development.
...
* [poetry2nix](https://github.com/nix-community/poetry2nix) ⭐ 929 | 🐛 188 | 🌐 Nix | 📅 2026-09-12 - Build Python packages directly from [Poetry's](https://python-poetry.org/) `poetry.lock`. No conversion step needed.
...
* [fenix](https://github.com/nix-community/fenix) ⭐ 1,115 | 🐛 38 | 🌐 Nix | 📅 2026-09-12 - Rust toolchains and Rust analyzer nightly for nix.
...
* [nix-cargo-integration](https://github.com/90-008/nix-cargo-integration) ⭐ 217 | 🐛 5 | 🌐 Nix | 📅 2026-09-12 - A library that allows easy and effortless integration for Cargo projects.
...
* [zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 191 | 🐛 6 | 🌐 Zig | 📅 2026-09-12 - Flake for packaging, building and running Zig projects.
...
* [Home Manager](https://github.com/nix-community/home-manager) ⭐ 10,341 | 🐛 992 | 🌐 Nix | 📅 2026-09-12 - Manage your user configuration just like NixOS.
* [nix-darwin](https://github.com/nix-darwin/nix-darwin) ⭐ 5,916 | 🐛 477 | 🌐 Nix | 📅 2026-08-16 - Manage macOS configuration just like on NixOS.
...
* [Nixvim](https://github.com/nix-community/nixvim) ⭐ 2,946 | 🐛 161 | 🌐 Nix | 📅 2026-09-12 - A pre-packaged Neovim distribution built with Nix modules and Nixpkgs.
* [Stylix](https://github.com/nix-community/stylix) ⭐ 2,398 | 🐛 286 | 🌐 Nix | 📅 2026-09-01 - System-wide colorscheming and typography for NixOS.
...
* [nvf](https://github.com/NotAShelf/nvf) ⭐ 1,627 | 🐛 127 | 🌐 Nix | 📅 2026-09-12 - A portable, modular Neovim configuration framework for Nix.
...
* [Self Host Blocks](https://github.com/ibizaman/selfhostblocks) ⭐ 495 | 🐛 118 | 🌐 Nix | 📅 2026-09-12 - Modular server management based on NixOS modules and focused on best practices.
...
* [NUR](https://github.com/nix-community/NUR/) ⭐ 1,947 | 🐛 38 | 🌐 Python | 📅 2026-09-12 - Nix User Repositories. The mother of all overlays, allowing access to user repositories and installing packages via attributes.
...
* [rust-overlay](https://github.com/oxalica/rust-overlay) ⭐ 1,556 | 🐛 23 | 🌐 Nix | 📅 2026-09-12 - Pure and reproducible nix overlay of binary distributed Rust toolchains.
...
* [zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 545 | 🐛 10 | 🌐 Nix | 📅 2026-09-12 - A Nix flake packaging the Zig compiler. The flake mirrors the binaries built officially by Zig and does not build them from source.
* [neovim-nightly-overlay](https://github.com/nix-community/neovim-nightly-overlay) ⭐ 418 | 🐛 1 | 🌐 Nix | 📅 2026-09-12 - Daily bumped Neovim nightly package.
* [awesome-nix-hpc](https://github.com/freuk/awesome-nix-hpc) ⭐ 102 | 🐛 0 | 📅 2025-04-22 - High Performance Computing package sets.
* [nixpkgs-firefox-darwin](https://github.com/bandithedoge/nixpkgs-firefox-darwin) ⭐ 74 | 🐛 3 | 🌐 Nix | 📅 2026-09-12 - Automatically updated Firefox binary packages for macOS.

## Distributions

* [nixbsd](https://github.com/nixos-bsd/nixbsd) ⭐ 1,047 | 🐛 21 | 🌐 Nix | 📅 2026-09-11 - A NixOS fork with a FreeBSD kernel.
