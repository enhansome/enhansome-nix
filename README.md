...
[Nix](https://github.com/nixos/nix) ⭐ 17,694 | 🐛 2,954 | 🌐 C++ | 📅 2026-09-13 is a powerful package manager for Linux and other Unix systems that makes package management reliable and reproducible.
...
* [Nix Starter Config](https://github.com/Misterio77/nix-starter-configs) ⭐ 3,833 | 🐛 16 | 🌐 Nix | 📅 2026-04-24 - A few simple Nix Flake templates for getting started with NixOS + home-manager.
* [NixOS & Flakes Book](https://github.com/ryan4yin/nixos-and-flakes-book) ⭐ 3,286 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-05 - An unofficial and opinionated NixOS & Flakes book for beginners.
...
* [NüschtOS Search](https://github.com/NuschtOS/search) ⭐ 168 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-13 - Simple and fast static-page NixOS option search.
...
* [nix-installer](https://github.com/DeterminateSystems/nix-installer) ⭐ 3,685 | 🐛 439 | 🌐 Rust | 📅 2026-09-13 - Opinionated alternative to the official Nix install scripts.
* [nixos-anywhere](https://github.com/nix-community/nixos-anywhere) ⭐ 3,440 | 🐛 104 | 🌐 Shell | 📅 2026-09-09 - Install NixOS everywhere via SSH.
...
* [Colmena](https://github.com/nix-community/colmena) ⭐ 2,342 | 🐛 147 | 🌐 Rust | 📅 2026-09-10 - A simple, stateless NixOS deployment tool modeled after NixOps and morph.
* [deploy-rs](https://github.com/serokell/deploy-rs) ⭐ 2,316 | 🐛 133 | 🌐 Rust | 📅 2026-09-10 - A simple multi-profile Nix-flake deploy tool.
...
* [comin](https://github.com/nlewo/comin) ⭐ 1,012 | 🐛 47 | 🌐 Go | 📅 2026-08-28 - A deployment tool to continuously pull from Git repositories.
* [KuberNix](https://github.com/saschagrunert/kubernix) ⭐ 824 | 🐛 0 | 🌐 Rust | 📅 2026-09-10 - Single-dependency Kubernetes clusters via Nix packages.
* [KubeNix](https://github.com/hall/kubenix) ⭐ 519 | 🐛 28 | 🌐 Nix | 📅 2026-09-13 - A Kubernetes resource builder using Nix.
...
* [microvm](https://github.com/microvm-nix/microvm.nix) ⭐ 2,923 | 🐛 57 | 🌐 Nix | 📅 2026-09-12 - NixOS-based MicroVMs.
* [nixos-shell](https://github.com/Mic92/nixos-shell) ⭐ 914 | 🐛 14 | 🌐 Nix | 📅 2026-06-30 - Simple headless VM configuration using Nix (similar to Vagrant).
...
* [agent-sandbox.nix](https://github.com/archie-judd/agent-sandbox.nix) ⭐ 156 | 🐛 1 | 🌐 Shell | 📅 2026-09-13 - Declarative sandboxing for any package (e.g. AI coding agents) using bubblewrap on Linux and sandbox-exec on macOS.

## Command-Line Tools

* [devenv](https://github.com/cachix/devenv) ⭐ 7,640 | 🐛 369 | 🌐 Rust | 📅 2026-09-13 - A Nix-based tool for creating developer shell environments quickly and reproducibly.
* [nh](https://github.com/nix-community/nh) ⭐ 3,195 | 🐛 85 | 🌐 Rust | 📅 2026-09-13 - Better output for `nix`, `nixos-rebuild`, `home-manager` and nix-darwin CLI leveraging `dix` and `nix-output-monitor`.
* [comma](https://github.com/nix-community/comma) ⭐ 1,762 | 🐛 11 | 🌐 Rust | 📅 2026-09-01 - Quickly run any binary; wraps together `nix run` and `nix-index`.
* [nix-output-monitor](https://github.com/maralorn/nix-output-monitor) ⭐ 1,657 | 🐛 111 | 🌐 Haskell | 📅 2026-08-28 - A tool to produce useful graphs and statistics when building derivations.
* [nixfmt](https://github.com/NixOS/nixfmt) ⭐ 1,604 | 🐛 20 | 🌐 Haskell | 📅 2026-09-11 - A formatter for Nix code, intended to easily apply a uniform style.
* [nix-init](https://github.com/nix-community/nix-init) ⭐ 1,463 | 🐛 31 | 🌐 Rust | 📅 2026-09-10 - Generate Nix packages from URLs with hash prefetching, dependency inference, license detection, and more.
* [alejandra](https://github.com/kamadorueda/alejandra) ⭐ 1,399 | 🐛 64 | 🌐 Nix | 📅 2026-09-11 - An opinionated Nix code formatter optimized for speed and consistency.
...
* [nix-tree](https://github.com/utdemir/nix-tree) ⭐ 1,073 | 🐛 20 | 🌐 Haskell | 📅 2026-09-01 - Interactively browse the dependency graph of Nix derivations.
* [statix](https://github.com/oppiliappan/statix) ⭐ 945 | 🐛 46 | 🌐 Rust | 📅 2026-07-26 - A linter/fixer to check for and fix antipatterns in Nix code.
* [nix-alien](https://github.com/thiagokokada/nix-alien) ⭐ 874 | 🐛 1 | 🌐 Python | 📅 2026-07-15 - Run unpatched binaries on Nix/NixOS easily.
* [nurl](https://github.com/nix-community/nurl) ⭐ 785 | 🐛 17 | 🌐 Rust | 📅 2026-09-11 - Generate Nix fetcher calls from repository URLs.
* [deadnix](https://github.com/astro/deadnix) ⭐ 781 | 🐛 7 | 🌐 Rust | 📅 2026-09-05 - Scan Nix files for dead code.
...
* [dix](https://github.com/manic-systems/dix) ⭐ 348 | 🐛 6 | 🌐 Rust | 📅 2026-09-12 - Diff Nix; a super-fast tool to diff Nix related things.
...
* [nix-melt](https://github.com/nix-community/nix-melt) ⭐ 314 | 🐛 5 | 🌐 Rust | 📅 2026-09-08 - A ranger-like flake.lock viewer.
* [nix-prefetch](https://github.com/msteen/nix-prefetch) ⭐ 151 | 🐛 23 | 🌐 Shell | 📅 2023-03-06 - A universal tool for updating source checksums.
* [angrr](https://github.com/linyinfeng/angrr) ⭐ 145 | 🐛 7 | 🌐 Rust | 📅 2026-09-11 - Auto Nix GC Roots Retention. This tool simply deletes auto GC roots based on the modified time of their symbolic link target.
...
* [Devbox](https://github.com/jetify-com/devbox) ⭐ 12,355 | 🐛 489 | 🌐 Go | 📅 2026-09-13 - Instant, portable, and predictable development environments.
* [flox](https://github.com/flox/flox) ⭐ 4,125 | 🐛 447 | 🌐 Rust | 📅 2026-09-11 - Manage and share development environments, package projects, and publish artifacts anywhere.
* [nix-direnv](https://github.com/nix-community/nix-direnv) ⭐ 2,772 | 🐛 7 | 🌐 Shell | 📅 2026-09-13 - A fast loader and flake-compliant configuration for the direnv environment auto-loader.
* [attic](https://github.com/zhaofengli/attic) ⭐ 2,064 | 🐛 169 | 🌐 Rust | 📅 2026-09-09 - Multi-tenant Nix Binary Cache.
* [nil](https://github.com/oxalica/nil) ⭐ 1,908 | 🐛 34 | 🌐 Rust | 📅 2026-07-26 - NIx Language server, an incremental analysis assistent for writing in Nix.
* [niv](https://github.com/nmattia/niv/) ⭐ 1,859 | 🐛 87 | 🌐 Haskell | 📅 2026-09-11 - Easy dependency management for Nix projects with package pinning.
...
* [devshell](https://github.com/numtide/devshell) ⭐ 1,554 | 🐛 97 | 🌐 Nix | 📅 2026-09-02 - `mkShell` with extra bits and a toml config option to be able to onboard non-nix users.
* [nixd](https://github.com/nix-community/nixd) ⭐ 1,480 | 🐛 105 | 🌐 C++ | 📅 2026-09-07 - Nix language server, based on Nix libraries.
* [flake.parts](https://github.com/hercules-ci/flake-parts) ⭐ 1,467 | 🐛 76 | 🌐 Nix | 📅 2026-09-03 - Minimal Nix modules framework for Flakes: split your flakes into modules and get things done with community modules.
...
* [nix2container](https://github.com/nlewo/nix2container) ⭐ 911 | 🐛 89 | 🌐 Go | 📅 2026-09-07 - An efficient container building workflow with Nix.
* [compose2nix](https://github.com/aksiksi/compose2nix) ⭐ 897 | 🐛 14 | 🌐 Go | 📅 2026-08-25 - Generate a NixOS config from a Docker Compose project.
...
* [nix-update](https://github.com/Mic92/nix-update) ⭐ 875 | 🐛 52 | 🌐 Python | 📅 2026-09-13 - Update versions/source hashes of nix packages.
* [pre-commit-hooks.nix](https://github.com/cachix/git-hooks.nix) ⭐ 864 | 🐛 98 | 🌐 Nix | 📅 2026-09-07 - Run linters/formatters at commit time and on your CI.
* [MCP-NixOS](https://github.com/utensils/mcp-nixos) ⭐ 830 | 🐛 0 | 🌐 Python | 📅 2026-09-05 - An MCP server that provides AI assistants with accurate information about NixOS packages, options, Home Manager, and nix-darwin configurations.
* [robotnix](https://github.com/nix-community/robotnix) ⭐ 807 | 🐛 80 | 🌐 Nix | 📅 2026-09-10 - A declarative and reproducible build system for Android (AOSP) images.
* [services-flake](https://github.com/juspay/services-flake) ⭐ 766 | 🐛 55 | 🌐 Nix | 📅 2026-09-13 - A NixOS-like service configuration framework for Nix flakes.
* [rnix-lsp](https://github.com/nix-community/rnix-lsp) ⚠️ Archived - A syntax-checking language server for Nix.
* [treefmt-nix](https://github.com/numtide/treefmt-nix) ⭐ 648 | 🐛 96 | 🌐 Nix | 📅 2026-08-16 - A formatter that allows formatting all your project files with a single command, all via a single `.nix` file.
* [nixpkgs-review](https://github.com/Mic92/nixpkgs-review) ⭐ 640 | 🐛 70 | 🌐 Python | 📅 2026-09-12 - The best tool to verify that a pull-request in Nixpkgs is building properly.
* [Snowfall Lib](https://github.com/snowfallorg/lib) ⭐ 629 | 🐛 46 | 🌐 Nix | 📅 2026-07-17 - A library that makes it easy to manage your Nix flake by imposing an opinionated file structure.
...
* [flakelight](https://github.com/nix-community/flakelight) ⭐ 411 | 🐛 4 | 🌐 Nix | 📅 2026-09-13 - A modular flake framework aiming to minimize boilerplate.
...
* [nix-oci](https://github.com/Dauliac/nix-oci) ⭐ 116 | 🐛 3 | 🌐 Nix | 📅 2026-09-09 - A flake-parts module for building minimal, reproducible OCI containers using nix2container.
* [flake-edit](https://github.com/a-kenji/flake-edit) ⭐ 86 | 🐛 9 | 🌐 Rust | 📅 2026-09-07 - Edit your flake inputs with auto-follows and update functionality directly from the CLI.
...
* [crystal2nix](https://github.com/nix-community/crystal2nix) ⭐ 19 | 🐛 5 | 🌐 Crystal | 📅 2025-07-09 - Convert `shard.lock` into Nix expressions.
...
* [haskell.nix](https://github.com/input-output-hk/haskell.nix) ⭐ 632 | 🐛 105 | 🌐 Nix | 📅 2026-09-13 - Alternative Haskell Infrastructure for Nixpkgs.
* [cabal2nix](https://github.com/NixOS/cabal2nix) ⭐ 402 | 🐛 98 | 🌐 Haskell | 📅 2026-08-21 - Converts a Cabal file into a Nix build expression.
* [haskell-flake](https://github.com/srid/haskell-flake) ⭐ 240 | 🐛 42 | 🌐 Nix | 📅 2026-09-13 - A `flake-parts` Nix module for Haskell development.
...
* [nix-phps](https://github.com/fossar/nix-phps) ⭐ 83 | 🐛 9 | 🌐 Nix | 📅 2026-09-13 - Flake containing old and unmaintained PHP versions (intended for CI use).
...
* [poetry2nix](https://github.com/nix-community/poetry2nix) ⭐ 929 | 🐛 188 | 🌐 Nix | 📅 2026-09-13 - Build Python packages directly from [Poetry's](https://python-poetry.org/) `poetry.lock`. No conversion step needed.
...
* [crane](https://github.com/ipetkov/crane) ⭐ 1,460 | 🐛 40 | 🌐 Nix | 📅 2026-09-03 - A Nix library for building Cargo projects with incremental artifact caching.
* [fenix](https://github.com/nix-community/fenix) ⭐ 1,115 | 🐛 38 | 🌐 Nix | 📅 2026-09-13 - Rust toolchains and Rust analyzer nightly for nix.
...
* [nix-cargo-integration](https://github.com/90-008/nix-cargo-integration) ⭐ 217 | 🐛 5 | 🌐 Nix | 📅 2026-09-13 - A library that allows easy and effortless integration for Cargo projects.
...
* [zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 191 | 🐛 6 | 🌐 Zig | 📅 2026-09-13 - Flake for packaging, building and running Zig projects.
...
* [Home Manager](https://github.com/nix-community/home-manager) ⭐ 10,343 | 🐛 990 | 🌐 Nix | 📅 2026-09-13 - Manage your user configuration just like NixOS.
* [nix-darwin](https://github.com/nix-darwin/nix-darwin) ⭐ 5,919 | 🐛 478 | 🌐 Nix | 📅 2026-08-16 - Manage macOS configuration just like on NixOS.
* [NixOS hardware](https://github.com/NixOS/nixos-hardware) ⭐ 3,298 | 🐛 323 | 🌐 Nix | 📅 2026-09-11 - NixOS profiles to optimize settings for different hardware.
* [NixOS-WSL](https://github.com/nix-community/NixOS-WSL) ⭐ 3,088 | 🐛 43 | 🌐 Nix | 📅 2026-09-11 - Modules for running NixOS on the Windows Subsystem for Linux.
* [Nixvim](https://github.com/nix-community/nixvim) ⭐ 2,946 | 🐛 161 | 🌐 Nix | 📅 2026-09-13 - A pre-packaged Neovim distribution built with Nix modules and Nixpkgs.
* [Stylix](https://github.com/nix-community/stylix) ⭐ 2,401 | 🐛 286 | 🌐 Nix | 📅 2026-09-01 - System-wide colorscheming and typography for NixOS.
* [impermanence](https://github.com/nix-community/impermanence) ⭐ 1,887 | 🐛 106 | 🌐 Nix | 📅 2026-01-27 - Lets you choose what files and directories you want to keep between reboots.
* [nvf](https://github.com/NotAShelf/nvf) ⭐ 1,628 | 🐛 127 | 🌐 Nix | 📅 2026-09-12 - A portable, modular Neovim configuration framework for Nix.
* [nix-topology](https://github.com/oddlama/nix-topology) ⭐ 1,001 | 🐛 23 | 🌐 Nix | 📅 2026-06-22 - Generate infrastructure and network diagrams directly from your NixOS configuration.
* [musnix](https://github.com/musnix/musnix) ⭐ 947 | 🐛 14 | 🌐 Nix | 📅 2026-09-01 - Do real-time audio work in NixOS.
...
* [nix-mineral](https://github.com/cynicsketch/nix-mineral) ⭐ 557 | 🐛 41 | 🌐 Nix | 📅 2026-09-13 - Conveniently and reasonably harden NixOS.
* [Self Host Blocks](https://github.com/ibizaman/selfhostblocks) ⭐ 495 | 🐛 119 | 🌐 Nix | 📅 2026-09-13 - Modular server management based on NixOS modules and focused on best practices.
* [base16.nix](https://github.com/SenchoPens/base16.nix) ⭐ 286 | 🐛 3 | 🌐 Nix | 📅 2025-08-21 - Flake way to theme programs in [base16](https://github.com/chriskempson/base16) ⭐ 965 | 🐛 2 | 📅 2023-10-12 colorschemes, mustache template support included.
...
* [Nix Software Center](https://github.com/snowfallorg/nix-software-center) ⭐ 849 | 🐛 59 | 🌐 Rust | 📅 2026-04-07 - Install and manage Nix packages. Desktop app in Rust and GTK.
...
* [NUR](https://github.com/nix-community/NUR/) ⭐ 1,948 | 🐛 39 | 🌐 Python | 📅 2026-09-13 - Nix User Repositories. The mother of all overlays, allowing access to user repositories and installing packages via attributes.
* [System Manager](https://github.com/numtide/system-manager) ⭐ 1,723 | 🐛 63 | 🌐 Nix | 📅 2026-09-12 - A non-NixOS Linux system configuration tool built on Nix.
* [rust-overlay](https://github.com/oxalica/rust-overlay) ⭐ 1,557 | 🐛 23 | 🌐 Nix | 📅 2026-09-13 - Pure and reproducible nix overlay of binary distributed Rust toolchains.
* [nixpkgs-wayland](https://github.com/nix-community/nixpkgs-wayland) ⭐ 628 | 🐛 55 | 🌐 Nix | 📅 2026-09-12 - Bleeding-edge Wayland packages.
* [nixpkgs-mozilla](https://github.com/mozilla/nixpkgs-mozilla) ⚠️ Archived - Mozilla's overlay with Rust toolchains and Firefox.
* [zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 545 | 🐛 10 | 🌐 Nix | 📅 2026-09-13 - A Nix flake packaging the Zig compiler. The flake mirrors the binaries built officially by Zig and does not build them from source.
* [neovim-nightly-overlay](https://github.com/nix-community/neovim-nightly-overlay) ⭐ 418 | 🐛 1 | 🌐 Nix | 📅 2026-09-13 - Daily bumped Neovim nightly package.
* [awesome-nix-hpc](https://github.com/freuk/awesome-nix-hpc) ⭐ 102 | 🐛 0 | 📅 2025-04-22 - High Performance Computing package sets.
* [nixpkgs-firefox-darwin](https://github.com/bandithedoge/nixpkgs-firefox-darwin) ⭐ 74 | 🐛 3 | 🌐 Nix | 📅 2026-09-13 - Automatically updated Firefox binary packages for macOS.

## Distributions

* [nixbsd](https://github.com/nixos-bsd/nixbsd) ⭐ 1,048 | 🐛 21 | 🌐 Nix | 📅 2026-09-11 - A NixOS fork with a FreeBSD kernel.
