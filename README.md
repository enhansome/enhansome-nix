...
[Nix](https://github.com/nixos/nix) ⭐ 17,642 | 🐛 2,942 | 🌐 C++ | 📅 2026-09-05 is a powerful package manager for Linux and other Unix systems that makes package management reliable and reproducible.
...
* [Nix Starter Config](https://github.com/Misterio77/nix-starter-configs) ⭐ 3,827 | 🐛 16 | 🌐 Nix | 📅 2026-04-24 - A few simple Nix Flake templates for getting started with NixOS + home-manager.
...
* [nix-installer](https://github.com/DeterminateSystems/nix-installer) ⭐ 3,680 | 🐛 440 | 🌐 Rust | 📅 2026-09-03 - Opinionated alternative to the official Nix install scripts.
* [nixos-anywhere](https://github.com/nix-community/nixos-anywhere) ⭐ 3,429 | 🐛 107 | 🌐 Shell | 📅 2026-09-02 - Install NixOS everywhere via SSH.
...
* [Colmena](https://github.com/nix-community/colmena) ⭐ 2,335 | 🐛 146 | 🌐 Rust | 📅 2026-08-20 - A simple, stateless NixOS deployment tool modeled after NixOps and morph.
...
* [comin](https://github.com/nlewo/comin) ⭐ 1,000 | 🐛 46 | 🌐 Go | 📅 2026-08-28 - A deployment tool to continuously pull from Git repositories.
...
* [KubeNix](https://github.com/hall/kubenix) ⭐ 514 | 🐛 27 | 🌐 Nix | 📅 2026-08-30 - A Kubernetes resource builder using Nix.
...
* [microvm](https://github.com/microvm-nix/microvm.nix) ⭐ 2,904 | 🐛 59 | 🌐 Nix | 📅 2026-09-04 - NixOS-based MicroVMs.
...
* [agent-sandbox.nix](https://github.com/archie-judd/agent-sandbox.nix) ⭐ 149 | 🐛 13 | 🌐 Shell | 📅 2026-09-05 - Declarative sandboxing for any package (e.g. AI coding agents) using bubblewrap on Linux and sandbox-exec on macOS.

## Command-Line Tools

* [devenv](https://github.com/cachix/devenv) ⭐ 7,493 | 🐛 379 | 🌐 Rust | 📅 2026-09-05 - A Nix-based tool for creating developer shell environments quickly and reproducibly.
* [nh](https://github.com/nix-community/nh) ⭐ 3,179 | 🐛 80 | 🌐 Rust | 📅 2026-09-03 - Better output for `nix`, `nixos-rebuild`, `home-manager` and nix-darwin CLI leveraging `dix` and `nix-output-monitor`.
* [comma](https://github.com/nix-community/comma) ⭐ 1,754 | 🐛 11 | 🌐 Rust | 📅 2026-09-01 - Quickly run any binary; wraps together `nix run` and `nix-index`.
...
* [nixfmt](https://github.com/NixOS/nixfmt) ⭐ 1,598 | 🐛 23 | 🌐 Haskell | 📅 2026-09-02 - A formatter for Nix code, intended to easily apply a uniform style.
...
* [nurl](https://github.com/nix-community/nurl) ⭐ 781 | 🐛 16 | 🌐 Rust | 📅 2026-09-05 - Generate Nix fetcher calls from repository URLs.
...
* [Devbox](https://github.com/jetify-com/devbox) ⭐ 12,333 | 🐛 496 | 🌐 Go | 📅 2026-09-04 - Instant, portable, and predictable development environments.
* [flox](https://github.com/flox/flox) ⭐ 4,121 | 🐛 443 | 🌐 Rust | 📅 2026-09-05 - Manage and share development environments, package projects, and publish artifacts anywhere.
* [nix-direnv](https://github.com/nix-community/nix-direnv) ⭐ 2,769 | 🐛 7 | 🌐 Shell | 📅 2026-08-30 - A fast loader and flake-compliant configuration for the direnv environment auto-loader.
* [attic](https://github.com/zhaofengli/attic) ⭐ 2,051 | 🐛 166 | 🌐 Rust | 📅 2026-09-02 - Multi-tenant Nix Binary Cache.
...
* [niv](https://github.com/nmattia/niv/) ⭐ 1,858 | 🐛 87 | 🌐 Haskell | 📅 2026-08-22 - Easy dependency management for Nix projects with package pinning.
...
* [devshell](https://github.com/numtide/devshell) ⭐ 1,551 | 🐛 97 | 🌐 Nix | 📅 2026-09-02 - `mkShell` with extra bits and a toml config option to be able to onboard non-nix users.
* [nixd](https://github.com/nix-community/nixd) ⭐ 1,478 | 🐛 105 | 🌐 C++ | 📅 2026-09-03 - Nix language server, based on Nix libraries.
* [flake.parts](https://github.com/hercules-ci/flake-parts) ⭐ 1,461 | 🐛 76 | 🌐 Nix | 📅 2026-09-03 - Minimal Nix modules framework for Flakes: split your flakes into modules and get things done with community modules.
...
* [Arion](https://github.com/hercules-ci/arion) ⭐ 915 | 🐛 99 | 🌐 Nix | 📅 2026-09-05 - Run `docker-compose` with help from Nix/NixOS.
* [nix2container](https://github.com/nlewo/nix2container) ⭐ 903 | 🐛 91 | 🌐 Go | 📅 2026-04-06 - An efficient container building workflow with Nix.
...
* [lorri](https://github.com/nix-community/lorri/) ⭐ 873 | 🐛 24 | 🌐 Go | 📅 2026-04-29 - A much better `nix-shell` for development that augments direnv.
* [nix-update](https://github.com/Mic92/nix-update) ⭐ 871 | 🐛 52 | 🌐 Python | 📅 2026-09-02 - Update versions/source hashes of nix packages.
...
* [MCP-NixOS](https://github.com/utensils/mcp-nixos) ⭐ 824 | 🐛 0 | 🌐 Python | 📅 2026-09-05 - An MCP server that provides AI assistants with accurate information about NixOS packages, options, Home Manager, and nix-darwin configurations.
* [robotnix](https://github.com/nix-community/robotnix) ⭐ 805 | 🐛 82 | 🌐 Nix | 📅 2026-08-23 - A declarative and reproducible build system for Android (AOSP) images.
* [services-flake](https://github.com/juspay/services-flake) ⭐ 766 | 🐛 59 | 🌐 Nix | 📅 2026-08-30 - A NixOS-like service configuration framework for Nix flakes.
...
* [namaka](https://github.com/nix-community/namaka) ⭐ 145 | 🐛 5 | 🌐 Rust | 📅 2026-09-04 - Snapshot testing for Nix based on haumea.
...
* [haskell.nix](https://github.com/input-output-hk/haskell.nix) ⭐ 632 | 🐛 105 | 🌐 Nix | 📅 2026-09-05 - Alternative Haskell Infrastructure for Nixpkgs.
...
* [nix-phps](https://github.com/fossar/nix-phps) ⭐ 83 | 🐛 10 | 🌐 Nix | 📅 2026-09-05 - Flake containing old and unmaintained PHP versions (intended for CI use).
...
* [poetry2nix](https://github.com/nix-community/poetry2nix) ⭐ 929 | 🐛 188 | 🌐 Nix | 📅 2026-09-05 - Build Python packages directly from [Poetry's](https://python-poetry.org/) `poetry.lock`. No conversion step needed.
* [uv2nix](https://github.com/pyproject-nix/uv2nix) ⭐ 774 | 🐛 2 | 🌐 Nix | 📅 2026-08-29 - Convert [`uv` workspaces](https://docs.astral.sh/uv/concepts/projects/workspaces/) into pure Nix derivations.
...
* [fenix](https://github.com/nix-community/fenix) ⭐ 1,116 | 🐛 38 | 🌐 Nix | 📅 2026-09-05 - Rust toolchains and Rust analyzer nightly for nix.
...
* [nix-cargo-integration](https://github.com/90-008/nix-cargo-integration) ⭐ 217 | 🐛 5 | 🌐 Nix | 📅 2026-09-05 - A library that allows easy and effortless integration for Cargo projects.
...
* [zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 190 | 🐛 6 | 🌐 Zig | 📅 2026-09-05 - Flake for packaging, building and running Zig projects.
...
* [Home Manager](https://github.com/nix-community/home-manager) ⭐ 10,322 | 🐛 1,010 | 🌐 Nix | 📅 2026-09-05 - Manage your user configuration just like NixOS.
* [nix-darwin](https://github.com/nix-darwin/nix-darwin) ⭐ 5,905 | 🐛 475 | 🌐 Nix | 📅 2026-08-16 - Manage macOS configuration just like on NixOS.
* [NixOS hardware](https://github.com/NixOS/nixos-hardware) ⭐ 3,295 | 🐛 322 | 🌐 Nix | 📅 2026-09-03 - NixOS profiles to optimize settings for different hardware.
...
* [Nixvim](https://github.com/nix-community/nixvim) ⭐ 2,940 | 🐛 159 | 🌐 Nix | 📅 2026-09-05 - A pre-packaged Neovim distribution built with Nix modules and Nixpkgs.
* [Stylix](https://github.com/nix-community/stylix) ⭐ 2,392 | 🐛 282 | 🌐 Nix | 📅 2026-09-01 - System-wide colorscheming and typography for NixOS.
...
* [Self Host Blocks](https://github.com/ibizaman/selfhostblocks) ⭐ 495 | 🐛 125 | 🌐 Nix | 📅 2026-09-05 - Modular server management based on NixOS modules and focused on best practices.
...
* [NUR](https://github.com/nix-community/NUR/) ⭐ 1,945 | 🐛 41 | 🌐 Python | 📅 2026-09-05 - Nix User Repositories. The mother of all overlays, allowing access to user repositories and installing packages via attributes.
* [System Manager](https://github.com/numtide/system-manager) ⭐ 1,713 | 🐛 62 | 🌐 Nix | 📅 2026-09-05 - A non-NixOS Linux system configuration tool built on Nix.
* [rust-overlay](https://github.com/oxalica/rust-overlay) ⭐ 1,555 | 🐛 23 | 🌐 Nix | 📅 2026-09-05 - Pure and reproducible nix overlay of binary distributed Rust toolchains.
* [nixpkgs-wayland](https://github.com/nix-community/nixpkgs-wayland) ⭐ 628 | 🐛 55 | 🌐 Nix | 📅 2026-09-05 - Bleeding-edge Wayland packages.
* [nixpkgs-mozilla](https://github.com/mozilla/nixpkgs-mozilla) ⚠️ Archived - Mozilla's overlay with Rust toolchains and Firefox.
* [zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 542 | 🐛 10 | 🌐 Nix | 📅 2026-09-05 - A Nix flake packaging the Zig compiler. The flake mirrors the binaries built officially by Zig and does not build them from source.
* [neovim-nightly-overlay](https://github.com/nix-community/neovim-nightly-overlay) ⭐ 417 | 🐛 1 | 🌐 Nix | 📅 2026-09-05 - Daily bumped Neovim nightly package.
...
* [nixbsd](https://github.com/nixos-bsd/nixbsd) ⭐ 1,039 | 🐛 21 | 🌐 Nix | 📅 2026-07-10 - A NixOS fork with a FreeBSD kernel.
