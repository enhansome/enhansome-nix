...
[Nix](https://github.com/nixos/nix) ⭐ 17,608 | 🐛 2,933 | 🌐 C++ | 📅 2026-09-01 is a powerful package manager for Linux and other Unix systems that makes package management reliable and reproducible.
...
* [nix-installer](https://github.com/DeterminateSystems/nix-installer) ⭐ 3,680 | 🐛 439 | 🌐 Rust | 📅 2026-08-30 - Opinionated alternative to the official Nix install scripts.
* [nixos-anywhere](https://github.com/nix-community/nixos-anywhere) ⭐ 3,422 | 🐛 104 | 🌐 Shell | 📅 2026-08-26 - Install NixOS everywhere via SSH.
...
* [deploy-rs](https://github.com/serokell/deploy-rs) ⭐ 2,299 | 🐛 141 | 🌐 Rust | 📅 2026-09-01 - A simple multi-profile Nix-flake deploy tool.
...
* [comin](https://github.com/nlewo/comin) ⭐ 994 | 🐛 46 | 🌐 Go | 📅 2026-08-28 - A deployment tool to continuously pull from Git repositories.
...
* [microvm](https://github.com/microvm-nix/microvm.nix) ⭐ 2,902 | 🐛 56 | 🌐 Nix | 📅 2026-09-01 - NixOS-based MicroVMs.
...
* [agent-sandbox.nix](https://github.com/archie-judd/agent-sandbox.nix) ⭐ 149 | 🐛 12 | 🌐 Shell | 📅 2026-09-01 - Declarative sandboxing for any package (e.g. AI coding agents) using bubblewrap on Linux and sandbox-exec on macOS.

## Command-Line Tools

* [devenv](https://github.com/cachix/devenv) ⭐ 7,475 | 🐛 364 | 🌐 Rust | 📅 2026-08-31 - A Nix-based tool for creating developer shell environments quickly and reproducibly.
* [nh](https://github.com/nix-community/nh) ⭐ 3,166 | 🐛 84 | 🌐 Rust | 📅 2026-08-29 - Better output for `nix`, `nixos-rebuild`, `home-manager` and nix-darwin CLI leveraging `dix` and `nix-output-monitor`.
...
* [nixfmt](https://github.com/NixOS/nixfmt) ⭐ 1,593 | 🐛 23 | 🌐 Haskell | 📅 2026-09-01 - A formatter for Nix code, intended to easily apply a uniform style.
* [nix-init](https://github.com/nix-community/nix-init) ⭐ 1,463 | 🐛 26 | 🌐 Rust | 📅 2026-08-31 - Generate Nix packages from URLs with hash prefetching, dependency inference, license detection, and more.
* [alejandra](https://github.com/kamadorueda/alejandra) ⭐ 1,394 | 🐛 66 | 🌐 Nix | 📅 2026-04-25 - An opinionated Nix code formatter optimized for speed and consistency.
...
* [flox](https://github.com/flox/flox) ⭐ 4,112 | 🐛 443 | 🌐 Rust | 📅 2026-09-01 - Manage and share development environments, package projects, and publish artifacts anywhere.
...
* [nixd](https://github.com/nix-community/nixd) ⭐ 1,472 | 🐛 105 | 🌐 C++ | 📅 2026-08-31 - Nix language server, based on Nix libraries.
...
* [pre-commit-hooks.nix](https://github.com/cachix/git-hooks.nix) ⭐ 859 | 🐛 92 | 🌐 Nix | 📅 2026-09-01 - Run linters/formatters at commit time and on your CI.
* [MCP-NixOS](https://github.com/utensils/mcp-nixos) ⭐ 816 | 🐛 2 | 🌐 Python | 📅 2026-08-12 - An MCP server that provides AI assistants with accurate information about NixOS packages, options, Home Manager, and nix-darwin configurations.
...
* [haskell.nix](https://github.com/input-output-hk/haskell.nix) ⭐ 632 | 🐛 104 | 🌐 Nix | 📅 2026-09-01 - Alternative Haskell Infrastructure for Nixpkgs.
...
* [poetry2nix](https://github.com/nix-community/poetry2nix) ⭐ 929 | 🐛 188 | 🌐 Nix | 📅 2026-09-01 - Build Python packages directly from [Poetry's](https://python-poetry.org/) `poetry.lock`. No conversion step needed.
...
* [fenix](https://github.com/nix-community/fenix) ⭐ 1,115 | 🐛 38 | 🌐 Nix | 📅 2026-09-01 - Rust toolchains and Rust analyzer nightly for nix.
* [naersk](https://github.com/nix-community/naersk) ⭐ 1,007 | 🐛 65 | 🌐 Nix | 📅 2026-06-23 - Build Rust packages directly from `Cargo.lock`. No conversion step needed.
...
* [nix-cargo-integration](https://github.com/90-008/nix-cargo-integration) ⭐ 217 | 🐛 5 | 🌐 Nix | 📅 2026-09-01 - A library that allows easy and effortless integration for Cargo projects.
...
* [zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 188 | 🐛 6 | 🌐 Zig | 📅 2026-09-01 - Flake for packaging, building and running Zig projects.
...
* [Home Manager](https://github.com/nix-community/home-manager) ⭐ 10,301 | 🐛 1,007 | 🌐 Nix | 📅 2026-09-01 - Manage your user configuration just like NixOS.
* [nix-darwin](https://github.com/nix-darwin/nix-darwin) ⭐ 5,896 | 🐛 474 | 🌐 Nix | 📅 2026-08-16 - Manage macOS configuration just like on NixOS.
* [NixOS hardware](https://github.com/NixOS/nixos-hardware) ⭐ 3,291 | 🐛 314 | 🌐 Nix | 📅 2026-08-29 - NixOS profiles to optimize settings for different hardware.
* [NixOS-WSL](https://github.com/nix-community/NixOS-WSL) ⭐ 3,072 | 🐛 52 | 🌐 Nix | 📅 2026-08-30 - Modules for running NixOS on the Windows Subsystem for Linux.
* [Nixvim](https://github.com/nix-community/nixvim) ⭐ 2,935 | 🐛 157 | 🌐 Nix | 📅 2026-09-01 - A pre-packaged Neovim distribution built with Nix modules and Nixpkgs.
* [Stylix](https://github.com/nix-community/stylix) ⭐ 2,390 | 🐛 283 | 🌐 Nix | 📅 2026-09-01 - System-wide colorscheming and typography for NixOS.
* [impermanence](https://github.com/nix-community/impermanence) ⭐ 1,882 | 🐛 106 | 🌐 Nix | 📅 2026-01-27 - Lets you choose what files and directories you want to keep between reboots.
* [nvf](https://github.com/NotAShelf/nvf) ⭐ 1,622 | 🐛 127 | 🌐 Nix | 📅 2026-08-30 - A portable, modular Neovim configuration framework for Nix.
...
* [nix-mineral](https://github.com/cynicsketch/nix-mineral) ⭐ 556 | 🐛 40 | 🌐 Nix | 📅 2026-08-31 - Conveniently and reasonably harden NixOS.
* [Self Host Blocks](https://github.com/ibizaman/selfhostblocks) ⭐ 494 | 🐛 124 | 🌐 Nix | 📅 2026-09-01 - Modular server management based on NixOS modules and focused on best practices.
...
* [NUR](https://github.com/nix-community/NUR/) ⭐ 1,944 | 🐛 39 | 🌐 Python | 📅 2026-09-01 - Nix User Repositories. The mother of all overlays, allowing access to user repositories and installing packages via attributes.
...
* [rust-overlay](https://github.com/oxalica/rust-overlay) ⭐ 1,553 | 🐛 23 | 🌐 Nix | 📅 2026-09-01 - Pure and reproducible nix overlay of binary distributed Rust toolchains.
...
* [zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 542 | 🐛 10 | 🌐 Nix | 📅 2026-09-01 - A Nix flake packaging the Zig compiler. The flake mirrors the binaries built officially by Zig and does not build them from source.
* [neovim-nightly-overlay](https://github.com/nix-community/neovim-nightly-overlay) ⭐ 415 | 🐛 1 | 🌐 Nix | 📅 2026-09-01 - Daily bumped Neovim nightly package.
* [awesome-nix-hpc](https://github.com/freuk/awesome-nix-hpc) ⭐ 102 | 🐛 0 | 📅 2025-04-22 - High Performance Computing package sets.
* [nixpkgs-firefox-darwin](https://github.com/bandithedoge/nixpkgs-firefox-darwin) ⭐ 74 | 🐛 3 | 🌐 Nix | 📅 2026-09-01 - Automatically updated Firefox binary packages for macOS.

## Distributions

* [nixbsd](https://github.com/nixos-bsd/nixbsd) ⭐ 1,035 | 🐛 21 | 🌐 Nix | 📅 2026-07-10 - A NixOS fork with a FreeBSD kernel.
