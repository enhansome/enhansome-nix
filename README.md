...
[Nix](https://github.com/nixos/nix) ⭐ 17,782 | 🐛 2,976 | 🌐 C++ | 📅 2026-09-25 is a powerful package manager for Linux and other Unix systems that makes package management reliable and reproducible.
...
* [Nix Starter Config](https://github.com/Misterio77/nix-starter-configs) ⭐ 3,839 | 🐛 16 | 🌐 Nix | 📅 2026-04-24 - A few simple Nix Flake templates for getting started with NixOS + home-manager.
* [NixOS & Flakes Book](https://github.com/ryan4yin/nixos-and-flakes-book) ⭐ 3,304 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-05 - An unofficial and opinionated NixOS & Flakes book for beginners.
...
* [NüschtOS Search](https://github.com/NuschtOS/search) ⭐ 170 | 🐛 31 | 🌐 TypeScript | 📅 2026-09-20 - Simple and fast static-page NixOS option search.
...
* [nix-installer](https://github.com/DeterminateSystems/nix-installer) ⭐ 3,700 | 🐛 439 | 🌐 Rust | 📅 2026-09-24 - Opinionated alternative to the official Nix install scripts.
* [nixos-anywhere](https://github.com/nix-community/nixos-anywhere) ⭐ 3,458 | 🐛 104 | 🌐 Shell | 📅 2026-09-23 - Install NixOS everywhere via SSH.
...
* [nixos-infect](https://github.com/elitak/nixos-infect) ⭐ 1,927 | 🐛 76 | 🌐 Shell | 📅 2026-03-22 - Replace a running non-NixOS Linux host with NixOS.
...
* [`npc`](https://github.com/samestep/npc) ⭐ 100 | 🐛 6 | 🌐 Rust | 📅 2026-09-21 - CLI to view and bisect Nixpkgs channel history.
...
* [Colmena](https://github.com/nix-community/colmena) ⭐ 2,356 | 🐛 143 | 🌐 Rust | 📅 2026-09-23 - A simple, stateless NixOS deployment tool modeled after NixOps and morph.
* [deploy-rs](https://github.com/serokell/deploy-rs) ⭐ 2,336 | 🐛 133 | 🌐 Rust | 📅 2026-09-25 - A simple multi-profile Nix-flake deploy tool.
* [NixOps](https://github.com/NixOS/nixops) ⭐ 2,201 | 🐛 327 | 🌐 Python | 📅 2025-12-28 - The official Nix deployment tool, compatible with AWS, Hetzner, and more.
...
* [comin](https://github.com/nlewo/comin) ⭐ 1,031 | 🐛 46 | 🌐 Go | 📅 2026-09-16 - A deployment tool to continuously pull from Git repositories.
* [KuberNix](https://github.com/saschagrunert/kubernix) ⭐ 825 | 🐛 1 | 🌐 Rust | 📅 2026-09-24 - Single-dependency Kubernetes clusters via Nix packages.
* [KubeNix](https://github.com/hall/kubenix) ⭐ 522 | 🐛 28 | 🌐 Nix | 📅 2026-09-20 - A Kubernetes resource builder using Nix.
...
* [microvm](https://github.com/microvm-nix/microvm.nix) ⭐ 2,965 | 🐛 59 | 🌐 Nix | 📅 2026-09-25 - NixOS-based MicroVMs.
* [nixos-shell](https://github.com/Mic92/nixos-shell) ⭐ 917 | 🐛 13 | 🌐 Nix | 📅 2026-09-22 - Simple headless VM configuration using Nix (similar to Vagrant).
* [extra-container](https://github.com/erikarvstedt/extra-container) ⭐ 304 | 🐛 6 | 🌐 Shell | 📅 2026-01-10 - Run declarative NixOS containers from the command line.
* [agent-sandbox.nix](https://github.com/archie-judd/agent-sandbox.nix) ⭐ 167 | 🐛 4 | 🌐 Shell | 📅 2026-09-18 - Declarative sandboxing for any package (e.g. AI coding agents) using bubblewrap on Linux and sandbox-exec on macOS.

## Command-Line Tools

* [devenv](https://github.com/cachix/devenv) ⭐ 7,677 | 🐛 372 | 🌐 Rust | 📅 2026-09-25 - A Nix-based tool for creating developer shell environments quickly and reproducibly.
* [nh](https://github.com/nix-community/nh) ⭐ 3,228 | 🐛 86 | 🌐 Rust | 📅 2026-09-25 - Better output for `nix`, `nixos-rebuild`, `home-manager` and nix-darwin CLI leveraging `dix` and `nix-output-monitor`.
* [comma](https://github.com/nix-community/comma) ⭐ 1,774 | 🐛 12 | 🌐 Rust | 📅 2026-09-25 - Quickly run any binary; wraps together `nix run` and `nix-index`.
* [nix-output-monitor](https://github.com/maralorn/nix-output-monitor) ⭐ 1,662 | 🐛 112 | 🌐 Haskell | 📅 2026-08-28 - A tool to produce useful graphs and statistics when building derivations.
* [nixfmt](https://github.com/NixOS/nixfmt) ⭐ 1,616 | 🐛 22 | 🌐 Haskell | 📅 2026-09-22 - A formatter for Nix code, intended to easily apply a uniform style.
* [nix-init](https://github.com/nix-community/nix-init) ⭐ 1,471 | 🐛 30 | 🌐 Rust | 📅 2026-09-16 - Generate Nix packages from URLs with hash prefetching, dependency inference, license detection, and more.
* [alejandra](https://github.com/kamadorueda/alejandra) ⭐ 1,407 | 🐛 64 | 🌐 Nix | 📅 2026-09-11 - An opinionated Nix code formatter optimized for speed and consistency.
...
* [nix-tree](https://github.com/utdemir/nix-tree) ⭐ 1,078 | 🐛 20 | 🌐 Haskell | 📅 2026-09-01 - Interactively browse the dependency graph of Nix derivations.
...
* [nurl](https://github.com/nix-community/nurl) ⭐ 791 | 🐛 17 | 🌐 Rust | 📅 2026-09-22 - Generate Nix fetcher calls from repository URLs.
* [deadnix](https://github.com/astro/deadnix) ⭐ 784 | 🐛 7 | 🌐 Rust | 📅 2026-09-05 - Scan Nix files for dead code.
* [nix-diff](https://github.com/Gabriella439/nix-diff) ⭐ 497 | 🐛 15 | 🌐 Haskell | 📅 2026-06-10 - A tool to explain why two Nix derivations differ.
...
* [dix](https://github.com/manic-systems/dix) ⭐ 353 | 🐛 8 | 🌐 Rust | 📅 2026-09-21 - Diff Nix; a super-fast tool to diff Nix related things.
...
* [angrr](https://github.com/linyinfeng/angrr) ⭐ 147 | 🐛 6 | 🌐 Rust | 📅 2026-09-18 - Auto Nix GC Roots Retention. This tool simply deletes auto GC roots based on the modified time of their symbolic link target.
...
* [Devbox](https://github.com/jetify-com/devbox) ⭐ 12,375 | 🐛 416 | 🌐 Go | 📅 2026-09-25 - Instant, portable, and predictable development environments.
* [flox](https://github.com/flox/flox) ⭐ 4,143 | 🐛 441 | 🌐 Rust | 📅 2026-09-25 - Manage and share development environments, package projects, and publish artifacts anywhere.
* [nix-direnv](https://github.com/nix-community/nix-direnv) ⭐ 2,783 | 🐛 8 | 🌐 Shell | 📅 2026-09-20 - A fast loader and flake-compliant configuration for the direnv environment auto-loader.
* [attic](https://github.com/zhaofengli/attic) ⭐ 2,082 | 🐛 175 | 🌐 Rust | 📅 2026-09-25 - Multi-tenant Nix Binary Cache.
* [nil](https://github.com/oxalica/nil) ⭐ 1,913 | 🐛 36 | 🌐 Rust | 📅 2026-07-26 - NIx Language server, an incremental analysis assistent for writing in Nix.
* [niv](https://github.com/nmattia/niv/) ⭐ 1,861 | 🐛 87 | 🌐 Haskell | 📅 2026-09-11 - Easy dependency management for Nix projects with package pinning.
* [flake-utils](https://github.com/numtide/flake-utils) ⭐ 1,628 | 🐛 23 | 🌐 Nix | 📅 2024-11-13 - Pure Nix flake utility functions to help with writing flakes.
* [devshell](https://github.com/numtide/devshell) ⭐ 1,557 | 🐛 98 | 🌐 Nix | 📅 2026-09-02 - `mkShell` with extra bits and a toml config option to be able to onboard non-nix users.
* [nixd](https://github.com/nix-community/nixd) ⭐ 1,494 | 🐛 104 | 🌐 C++ | 📅 2026-09-21 - Nix language server, based on Nix libraries.
* [flake.parts](https://github.com/hercules-ci/flake-parts) ⭐ 1,477 | 🐛 76 | 🌐 Nix | 📅 2026-09-03 - Minimal Nix modules framework for Flakes: split your flakes into modules and get things done with community modules.
...
* [nix2container](https://github.com/nlewo/nix2container) ⭐ 916 | 🐛 92 | 🌐 Go | 📅 2026-09-24 - An efficient container building workflow with Nix.
* [compose2nix](https://github.com/aksiksi/compose2nix) ⭐ 901 | 🐛 15 | 🌐 Go | 📅 2026-08-25 - Generate a NixOS config from a Docker Compose project.
* [nix-update](https://github.com/Mic92/nix-update) ⭐ 881 | 🐛 53 | 🌐 Python | 📅 2026-09-20 - Update versions/source hashes of nix packages.
...
* [pre-commit-hooks.nix](https://github.com/cachix/git-hooks.nix) ⭐ 868 | 🐛 103 | 🌐 Nix | 📅 2026-09-25 - Run linters/formatters at commit time and on your CI.
* [MCP-NixOS](https://github.com/utensils/mcp-nixos) ⭐ 842 | 🐛 0 | 🌐 Python | 📅 2026-09-05 - An MCP server that provides AI assistants with accurate information about NixOS packages, options, Home Manager, and nix-darwin configurations.
* [robotnix](https://github.com/nix-community/robotnix) ⭐ 807 | 🐛 80 | 🌐 Nix | 📅 2026-09-25 - A declarative and reproducible build system for Android (AOSP) images.
* [services-flake](https://github.com/juspay/services-flake) ⭐ 769 | 🐛 55 | 🌐 Nix | 📅 2026-09-25 - A NixOS-like service configuration framework for Nix flakes.
* [rnix-lsp](https://github.com/nix-community/rnix-lsp) ⚠️ Archived - A syntax-checking language server for Nix.
* [treefmt-nix](https://github.com/numtide/treefmt-nix) ⭐ 654 | 🐛 102 | 🌐 Nix | 📅 2026-08-16 - A formatter that allows formatting all your project files with a single command, all via a single `.nix` file.
...
* [npins](https://github.com/andir/npins) ⭐ 574 | 🐛 31 | 🌐 Rust | 📅 2026-09-02 - A simple tool for handling different types of dependencies in a Nix project. It is inspired by and comparable to Niv.
...
* [flakelight](https://github.com/nix-community/flakelight) ⭐ 413 | 🐛 4 | 🌐 Nix | 📅 2026-09-21 - A modular flake framework aiming to minimize boilerplate.
...
* [pog](https://github.com/jpetrucciani/pog) ⭐ 202 | 🐛 3 | 🌐 Nix | 📅 2026-08-06 - A new, powerful way to do bash scripts. Pog is a powerful Nix library that transforms the way developers create command-line interfaces (CLIs).
...
* [clj-nix](https://github.com/jlesquembre/clj-nix) ⭐ 185 | 🐛 33 | 🌐 Clojure | 📅 2026-09-21 - Nix helper functions for Clojure projects.
...
* [deps\_nix](https://github.com/code-supply/deps_nix) ⭐ 60 | 🐛 8 | 🌐 Elixir | 📅 2026-09-05 - Converts Mix dependencies to Nix derivations.
...
* [haskell.nix](https://github.com/input-output-hk/haskell.nix) ⭐ 632 | 🐛 108 | 🌐 Nix | 📅 2026-09-25 - Alternative Haskell Infrastructure for Nixpkgs.
...
* [lean4-nix](https://github.com/lenianiva/lean4-nix) ⭐ 125 | 🐛 11 | 🌐 Nix | 📅 2026-08-27 -  Nix flake build for Lean 4, and `lake2nix`.

### Node.js

* [node2nix](https://github.com/svanderburg/node2nix) ⭐ 592 | 🐛 133 | 🌐 Nix | 📅 2024-11-18 - Generate Nix expression from a `package.json` (or `package-lock.json`) (to be stored as files).
...
* [composer2nix](https://github.com/svanderburg/composer2nix) ⭐ 92 | 🐛 15 | 🌐 Nix | 📅 2026-09-25 - Generate Nix expressions to build composer packages.
* [nix-phps](https://github.com/fossar/nix-phps) ⭐ 83 | 🐛 7 | 🌐 Nix | 📅 2026-09-25 - Flake containing old and unmaintained PHP versions (intended for CI use).
...
* [poetry2nix](https://github.com/nix-community/poetry2nix) ⭐ 927 | 🐛 188 | 🌐 Nix | 📅 2026-09-25 - Build Python packages directly from [Poetry's](https://python-poetry.org/) `poetry.lock`. No conversion step needed.
* [uv2nix](https://github.com/pyproject-nix/uv2nix) ⭐ 786 | 🐛 2 | 🌐 Nix | 📅 2026-09-25 - Convert [`uv` workspaces](https://docs.astral.sh/uv/concepts/projects/workspaces/) into pure Nix derivations.
...
* [crane](https://github.com/ipetkov/crane) ⭐ 1,466 | 🐛 40 | 🌐 Nix | 📅 2026-09-18 - A Nix library for building Cargo projects with incremental artifact caching.
* [fenix](https://github.com/nix-community/fenix) ⭐ 1,121 | 🐛 39 | 🌐 Nix | 📅 2026-09-25 - Rust toolchains and Rust analyzer nightly for nix.
...
* [nix-cargo-integration](https://github.com/90-008/nix-cargo-integration) ⭐ 217 | 🐛 5 | 🌐 Nix | 📅 2026-09-25 - A library that allows easy and effortless integration for Cargo projects.
...
* [zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 191 | 🐛 7 | 🌐 Zig | 📅 2026-09-25 - Flake for packaging, building and running Zig projects.
...
* [Home Manager](https://github.com/nix-community/home-manager) ⭐ 10,383 | 🐛 974 | 🌐 Nix | 📅 2026-09-25 - Manage your user configuration just like NixOS.
* [nix-darwin](https://github.com/nix-darwin/nix-darwin) ⭐ 5,954 | 🐛 479 | 🌐 Nix | 📅 2026-08-16 - Manage macOS configuration just like on NixOS.
* [NixOS hardware](https://github.com/NixOS/nixos-hardware) ⭐ 3,310 | 🐛 326 | 🌐 Nix | 📅 2026-09-25 - NixOS profiles to optimize settings for different hardware.
* [NixOS-WSL](https://github.com/nix-community/NixOS-WSL) ⭐ 3,099 | 🐛 50 | 🌐 Nix | 📅 2026-09-25 - Modules for running NixOS on the Windows Subsystem for Linux.
* [Nixvim](https://github.com/nix-community/nixvim) ⭐ 2,954 | 🐛 159 | 🌐 Nix | 📅 2026-09-25 - A pre-packaged Neovim distribution built with Nix modules and Nixpkgs.
* [Stylix](https://github.com/nix-community/stylix) ⭐ 2,412 | 🐛 288 | 🌐 Nix | 📅 2026-09-20 - System-wide colorscheming and typography for NixOS.
* [impermanence](https://github.com/nix-community/impermanence) ⭐ 1,893 | 🐛 106 | 🌐 Nix | 📅 2026-01-27 - Lets you choose what files and directories you want to keep between reboots.
* [nvf](https://github.com/NotAShelf/nvf) ⭐ 1,636 | 🐛 129 | 🌐 Nix | 📅 2026-09-24 - A portable, modular Neovim configuration framework for Nix.
* [nix-topology](https://github.com/oddlama/nix-topology) ⭐ 1,006 | 🐛 23 | 🌐 Nix | 📅 2026-06-22 - Generate infrastructure and network diagrams directly from your NixOS configuration.
* [musnix](https://github.com/musnix/musnix) ⭐ 951 | 🐛 14 | 🌐 Nix | 📅 2026-09-01 - Do real-time audio work in NixOS.
...
* [nix-mineral](https://github.com/cynicsketch/nix-mineral) ⭐ 563 | 🐛 38 | 🌐 Nix | 📅 2026-09-20 - Conveniently and reasonably harden NixOS.
* [Self Host Blocks](https://github.com/ibizaman/selfhostblocks) ⭐ 501 | 🐛 119 | 🌐 Nix | 📅 2026-09-25 - Modular server management based on NixOS modules and focused on best practices.
* [base16.nix](https://github.com/SenchoPens/base16.nix) ⭐ 286 | 🐛 3 | 🌐 Nix | 📅 2025-08-21 - Flake way to theme programs in [base16](https://github.com/chriskempson/base16) ⭐ 968 | 🐛 2 | 📅 2023-10-12 colorschemes, mustache template support included.
...
* [Nix Software Center](https://github.com/snowfallorg/nix-software-center) ⭐ 852 | 🐛 59 | 🌐 Rust | 📅 2026-04-07 - Install and manage Nix packages. Desktop app in Rust and GTK.
* [NixOS Configuration Editor](https://github.com/snowfallorg/nixos-conf-editor) ⭐ 680 | 🐛 13 | 🌐 Rust | 📅 2026-02-15 - Graphical editor for NixOS configuration. Desktop app in Rust and GTK.
...
* [NUR](https://github.com/nix-community/NUR/) ⭐ 1,957 | 🐛 42 | 🌐 Python | 📅 2026-09-25 - Nix User Repositories. The mother of all overlays, allowing access to user repositories and installing packages via attributes.
* [System Manager](https://github.com/numtide/system-manager) ⭐ 1,742 | 🐛 61 | 🌐 Nix | 📅 2026-09-24 - A non-NixOS Linux system configuration tool built on Nix.
* [rust-overlay](https://github.com/oxalica/rust-overlay) ⭐ 1,565 | 🐛 23 | 🌐 Nix | 📅 2026-09-25 - Pure and reproducible nix overlay of binary distributed Rust toolchains.
* [nixpkgs-wayland](https://github.com/nix-community/nixpkgs-wayland) ⭐ 628 | 🐛 56 | 🌐 Nix | 📅 2026-09-25 - Bleeding-edge Wayland packages.
* [nixpkgs-mozilla](https://github.com/mozilla/nixpkgs-mozilla) ⚠️ Archived - Mozilla's overlay with Rust toolchains and Firefox.
* [zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 549 | 🐛 10 | 🌐 Nix | 📅 2026-09-25 - A Nix flake packaging the Zig compiler. The flake mirrors the binaries built officially by Zig and does not build them from source.
* [neovim-nightly-overlay](https://github.com/nix-community/neovim-nightly-overlay) ⭐ 418 | 🐛 2 | 🌐 Nix | 📅 2026-09-25 - Daily bumped Neovim nightly package.
* [awesome-nix-hpc](https://github.com/freuk/awesome-nix-hpc) ⭐ 102 | 🐛 0 | 📅 2025-04-22 - High Performance Computing package sets.
* [nixpkgs-firefox-darwin](https://github.com/bandithedoge/nixpkgs-firefox-darwin) ⭐ 74 | 🐛 3 | 🌐 Nix | 📅 2026-09-25 - Automatically updated Firefox binary packages for macOS.

## Distributions

* [nixbsd](https://github.com/nixos-bsd/nixbsd) ⭐ 1,050 | 🐛 21 | 🌐 Nix | 📅 2026-09-11 - A NixOS fork with a FreeBSD kernel.
* [NixNG](https://github.com/nix-community/NixNG) ⭐ 501 | 🐛 22 | 🌐 Nix | 📅 2026-08-01 - A GNU/Linux distribution similar to NixOS. The defining difference is a focus on containers and lightweightness.
